...
import ai.marketingclaw.app.gateway.GatewayCustomHeaders
import ai.marketingclaw.app.gateway.GatewayRegistryStore
import ai.marketingclaw.app.gateway.GatewayStoreMigration
...
class SecurePrefs(
  ...
  companion object {
    val defaultWakeWords: List<String> = listOf("marketingclaw", "claude")
    private const val displayNameKey = "node.displayName"
    private const val locationModeKey = "location.enabledMode"
    private const val voiceWakeModeKey = "voiceWake.mode"
    private const val plainPrefsName = "marketingclaw.node"
    private const val securePrefsName = "marketingclaw.node.secure"
  ...
  internal fun getNotificationForwardingPolicy(appPackageName: String): NotificationForwardingPolicy {
    ...
    // Always block MarketingClaw's own notifications in blocklist mode to prevent forwarding loops.
