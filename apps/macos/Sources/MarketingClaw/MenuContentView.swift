...
/// Menu contents for the MarketingClaw menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About MarketingClaw") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "MarketingClaw Not Configured"
        case .remote:
            "Remote MarketingClaw Active"
        case .local:
            "MarketingClaw Active"
        }
    }
