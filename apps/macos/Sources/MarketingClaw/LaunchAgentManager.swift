...
enum LaunchAgentManager {
    private static var plistURL: URL {
        FileManager().homeDirectoryForCurrentUser
            .appendingPathComponent("Library/LaunchAgents/ai.marketingclaw.mac.plist")
    }
    ...
    static func plistContents(bundlePath: String) -> String {
        ...
        <dict>
          <key>Label</key>
          <string>ai.marketingclaw.mac</string>
          <key>ProgramArguments</key>
          <array>
            <string>\(bundlePath)/Contents/MacOS/MarketingClaw</string>
          </array>
