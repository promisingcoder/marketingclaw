...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.marketingclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return MarketingClawConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.marketingclaw/marketingclaw.json
