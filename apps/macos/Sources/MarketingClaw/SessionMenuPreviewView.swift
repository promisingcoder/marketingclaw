...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.marketingclaw", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> MarketingClawSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: MarketingClawSessionPreviewEntry,
    ...
    private static func cache(payload: MarketingClawSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: MarketingClawChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [MarketingClawKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [MarketingClawKit.AnyCodable]) -> [MarketingClawChatMessage] {
    ...
    private static func previewText(for message: MarketingClawChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: MarketingClawChatMessage) -> Bool {
    ...
    private static func toolNames(for message: MarketingClawChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: MarketingClawChatMessage) -> String? {
