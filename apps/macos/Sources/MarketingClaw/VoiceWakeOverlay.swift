...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.marketingclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other MarketingClaw windows, but below the system’s pop-up menus.
