...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.marketingclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("MarketingClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__marketingclaw__/a2ui/").absoluteString + "?platform=macos"
    }
