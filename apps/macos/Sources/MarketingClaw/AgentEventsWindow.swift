...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: MarketingClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": MarketingClawProtocol.AnyCodable("start"),
                "name": MarketingClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
