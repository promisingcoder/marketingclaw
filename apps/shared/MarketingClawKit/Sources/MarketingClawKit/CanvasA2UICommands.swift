...
public enum MarketingClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct MarketingClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct MarketingClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
