...
enum ChatMessageVisibleText {
    static func visibleText(in message: MarketingClawChatMessage) -> String {
    ...
    static func hasVisibleText(in message: MarketingClawChatMessage) -> Bool {
        !self.visibleText(in: message)
            .trimmingCharacters(in: .whitespacesAndNewlines)
            .isEmpty
    }

    private static func primaryText(in message: MarketingClawChatMessage) -> String {
