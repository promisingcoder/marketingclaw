...
@MainActor @Observable final class WatchInboxStore {
    ...
    private static let defaultTitle = "MarketingClaw"
    ...
    func consume(message: WatchNotifyMessage, transport: String) {
        ...
        let normalizedTitle = message.title.isEmpty ? "MarketingClaw" : message.title
        ...
        stillCurrent: @MainActor @Sendable () -> Bool = { true }) async
    {
        ...
        content.threadIdentifier = "marketingclaw-watch"
