...
struct LicenseDocumentLoaderTests {
    ...
    @Test func `derives readable titles from license filenames`() {
        ...
        #expect(LicenseDocumentLoader.title(from: "marketingclaw_plugin_sdk.txt") == "marketingclaw plugin sdk")
    ...
    private static func makeTemporaryDirectory() throws -> URL {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("MarketingClawLicenseDocumentLoaderTests-\(UUID().uuidString)", isDirectory: true)
