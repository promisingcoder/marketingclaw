...
actor CameraController {
    ...
    func snap(params: MarketingClawCameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: MarketingClawCameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("marketingclaw-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("marketingclaw-camera-\(UUID().uuidString).mp4")
        defer {
    ...
    private nonisolated static func pickCamera(
        facing: MarketingClawCameraFacing,
