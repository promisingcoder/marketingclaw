...
final class CalendarService: CalendarServicing {
    ...
    func events(params: MarketingClawCalendarEventsParams) async throws -> MarketingClawCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            MarketingClawCalendarEventPayload(
        ...
        return MarketingClawCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: MarketingClawCalendarAddParams) async throws -> MarketingClawCalendarAddPayload {
        ...
        let payload = MarketingClawCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return MarketingClawCalendarAddPayload(event: payload)
    }
