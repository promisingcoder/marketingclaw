...
private struct NotificationPermissionGuidanceCard: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text(
                    ...
                    Enable Notifications to receive approval notifications while MarketingClaw is not open.
                    """)
        ...
        .padding(18)
        .proPanelSurface(tint: MarketingClawBrand.warn, radius: 20, isProminent: true)
    }
}
