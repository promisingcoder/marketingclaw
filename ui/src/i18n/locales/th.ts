...
export const th: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "คิวอาร์โค้ดสำหรับจับคู่ MarketingClaw mobile",
      ...
      review: "ตรวจทาน",
      waiting: "แอป MarketingClaw mobile อย่างเป็นทางการจะเชื่อมต่อโดยอัตโนมัติหลังจากสแกน",
  ...
  worktrees: {
    ...
    subtitle: "การ checkout คลังแยกที่เป็นของ MarketingClaw",
  ...
  subtitles: {
    ...
    config: "แก้ไข marketingclaw.json",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "ใช้งานบนมือถืออยู่หรือไม่? คัดลอก URL แบบเต็ม (รวม #token=...) จาก marketingclaw dashboard --no-open บนเดสก์ท็อปของคุณ",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — ยืนยันตัวตนใหม่ด้วย marketingclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "วางโทเค็นจาก marketingclaw dashboard --no-open หรือป้อนรหัสผ่านที่ตั้งค่าไว้",
        stepGenerate:
          "ถ้ายังไม่ได้ตั้งค่าโทเค็น ให้รัน marketingclaw doctor --generate-gateway-token บนโฮสต์ Gateway",
      ...
      authFailed: {
        ...
        stepDashboard: "รัน marketingclaw dashboard --no-open แล้วเปิด URL ใหม่หรือวางโทเค็นของ URL นั้น",
      ...
      pairing: {
        ...
        stepList: "รัน marketingclaw devices list บนโฮสต์ Gateway",
        stepApproveId: "อนุมัติคำขอนี้: marketingclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "เปิด dashboard ที่เสิร์ฟอีกครั้งด้วย marketingclaw dashboard เพื่อให้ UI และ Gateway มาจากการติดตั้งเดียวกัน",
        stepDevUi: "ถ้าใช้ pnpm ui:dev ให้ build ใหม่หรือรีสตาร์ท UI dev กับ checkout ปัจจุบัน",
        stepRestart: "รีสตาร์ท Gateway หลังอัปเดต MarketingClaw เพื่อให้เสิร์ฟโปรโตคอลปัจจุบัน",
      },
      network: {
        ...
        stepGateway:
          "ยืนยันว่า Gateway กำลังทำงานด้วย marketingclaw status หรือ marketingclaw gateway run",
        stepUrl: "ตรวจสอบ WebSocket URL และใช้ wss:// เมื่อ Gateway อยู่หลัง HTTPS/Tailscale Serve",
        stepDashboard:
          "เปิด dashboard อีกครั้งด้วย marketingclaw dashboard --no-open เพื่อคัดลอก URL และรายละเอียด auth ปัจจุบันใหม่",
      },
    },
  },
  connection: {
