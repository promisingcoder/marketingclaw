...
export const it: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Codice QR di associazione di MarketingClaw mobile",
      ...
      review: "Revisione",
      waiting:
        "Le app mobile ufficiali di MarketingClaw si connettono automaticamente dopo la scansione.",
  ...
  worktrees: {
    ...
    subtitle: "Checkout di repository isolati di proprietà di MarketingClaw.",
  ...
  subtitles: {
    ...
    config: "Modifica marketingclaw.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Su mobile? Copia l'URL completo (incluso #token=...) da marketingclaw dashboard --no-open sul desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — riautenticati con marketingclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Incolla il token da marketingclaw dashboard --no-open oppure inserisci la password configurata.",
        stepGenerate:
          "Se non è configurato alcun token, esegui marketingclaw doctor --generate-gateway-token sull’host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Esegui marketingclaw dashboard --no-open e apri il nuovo URL oppure incolla il suo token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Esegui marketingclaw devices list sull’host Gateway.",
        stepApproveId: "Approva questa richiesta: marketingclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Riapri il dashboard servito con marketingclaw dashboard in modo che UI e Gateway provengano dalla stessa installazione.",
        stepDevUi:
          "Se usi pnpm ui:dev, ricompila o riavvia la UI di sviluppo contro il checkout corrente.",
        stepRestart:
          "Riavvia il Gateway dopo aver aggiornato MarketingClaw affinché serva il protocollo corrente.",
      },
      network: {
        ...
        stepGateway:
          "Conferma che il Gateway sia in esecuzione con marketingclaw status o marketingclaw gateway run.",
        stepUrl:
          "Controlla l’URL WebSocket e usa wss:// quando il Gateway è dietro HTTPS/Tailscale Serve.",
        stepDashboard:
          "Riapri il dashboard con marketingclaw dashboard --no-open per ricopiare l’URL corrente e i dettagli auth.",
      },
    },
  },
  connection: {
