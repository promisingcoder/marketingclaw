...
export const fa: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "کد QR جفت‌سازی موبایل MarketingClaw",
      ...
      review: "بازبینی",
      waiting: "برنامه‌های رسمی موبایل MarketingClaw پس از اسکن به‌صورت خودکار متصل می‌شوند.",
  ...
  worktrees: {
    ...
    subtitle: "checkoutهای ایزولهٔ مخزن که متعلق به MarketingClaw هستند.",
  ...
  subtitles: {
    ...
    config: "ویرایش marketingclaw.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "روی موبایل هستید؟ URL کامل (شامل #token=...) را از marketingclaw dashboard --no-open روی دسکتاپ خود کپی کنید.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — با marketingclaw models auth دوباره احراز هویت کنید",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "توکن marketingclaw dashboard --no-open را جای گذاری کنید یا گذرواژه پیکربندی شده را وارد کنید.",
        stepGenerate:
          "اگر توکنی پیکربندی نشده است، marketingclaw doctor --generate-gateway-token را روی میزبان Gateway اجرا کنید.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "marketingclaw dashboard --no-open را اجرا کنید و URL تازه را باز کنید یا توکن آن را جای گذاری کنید.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "marketingclaw devices list را روی میزبان Gateway اجرا کنید.",
        stepApproveId: "این درخواست را تأیید کنید: marketingclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "داشبورد سرو شده را با marketingclaw dashboard دوباره باز کنید تا UI و Gateway از همان نصب باشند.",
        stepDevUi:
          "اگر از pnpm ui:dev استفاده می کنید، UI توسعه را بر اساس checkout فعلی دوباره بسازید یا راه اندازی کنید.",
        stepRestart:
          "پس از به روزرسانی MarketingClaw، Gateway را دوباره راه اندازی کنید تا پروتکل فعلی را سرو کند.",
      },
      network: {
        ...
        stepGateway:
          "با marketingclaw status یا marketingclaw gateway run تأیید کنید که Gateway در حال اجرا است.",
        stepUrl:
          "URL WebSocket را بررسی کنید و وقتی Gateway پشت HTTPS/Tailscale Serve است از wss:// استفاده کنید.",
        stepDashboard:
          "داشبورد را با marketingclaw dashboard --no-open دوباره باز کنید تا URL و جزئیات احراز هویت فعلی را دوباره کپی کنید.",
      },
    },
  },
  connection: {
