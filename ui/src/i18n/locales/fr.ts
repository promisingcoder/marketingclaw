...
export const fr: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Code QR d’association MarketingClaw mobile",
      ...
      review: "Révision",
      waiting:
        "Les applications mobiles officielles MarketingClaw se connectent automatiquement après la numérisation.",
  ...
  worktrees: {
    ...
    subtitle: "Checkouts de dépôt isolés appartenant à MarketingClaw.",
  ...
  subtitles: {
    ...
    config: "Modifier marketingclaw.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Sur mobile ? Copiez l’URL complète (y compris #token=...) depuis marketingclaw dashboard --no-open sur votre ordinateur.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — réauthentifiez-vous avec marketingclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Collez le jeton de marketingclaw dashboard --no-open ou saisissez le mot de passe configuré.",
        stepGenerate:
          "Si aucun jeton n’est configuré, exécutez marketingclaw doctor --generate-gateway-token sur l’hôte Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Exécutez marketingclaw dashboard --no-open et ouvrez la nouvelle URL ou collez son jeton.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Exécutez marketingclaw devices list sur l’hôte Gateway.",
        stepApproveId: "Approuvez cette demande : marketingclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Rouvrez le dashboard servi avec marketingclaw dashboard afin que l’UI et le Gateway viennent de la même installation.",
        stepDevUi:
          "Si vous utilisez pnpm ui:dev, reconstruisez ou redémarrez l’UI de développement avec le checkout actuel.",
        stepRestart:
          "Redémarrez le Gateway après la mise à jour d’MarketingClaw afin qu’il serve le protocole actuel.",
      },
      network: {
        ...
        stepGateway:
          "Confirmez que le Gateway fonctionne avec marketingclaw status ou marketingclaw gateway run.",
        stepUrl:
          "Vérifiez l’URL WebSocket et utilisez wss:// lorsque le Gateway est derrière HTTPS/Tailscale Serve.",
        stepDashboard:
          "Rouvrez le dashboard avec marketingclaw dashboard --no-open pour recopier l’URL actuelle et les détails d’authentification.",
      },
    },
  },
  connection: {
