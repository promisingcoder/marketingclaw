...
export const pl: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Kod QR parowania MarketingClaw mobile",
      ...
      review: "Do przeglądu",
      waiting: "Oficjalne aplikacje mobilne MarketingClaw łączą się automatycznie po zeskanowaniu.",
  ...
  worktrees: {
    ...
    subtitle: "Izolowane kopie robocze repozytoriów należące do MarketingClaw.",
  ...
  subtitles: {
    ...
    config: "Edytuj marketingclaw.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Na urządzeniu mobilnym? Skopiuj pełny URL (w tym #token=...) z marketingclaw dashboard --no-open na komputerze.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — uwierzytelnij ponownie za pomocą marketingclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Wklej token z marketingclaw dashboard --no-open albo wpisz skonfigurowane hasło.",
        stepGenerate:
          "Jeśli token nie jest skonfigurowany, uruchom marketingclaw doctor --generate-gateway-token na hoście Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Uruchom marketingclaw dashboard --no-open i otwórz świeży URL albo wklej jego token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Uruchom marketingclaw devices list na hoście Gateway.",
        stepApproveId: "Zatwierdź to żądanie: marketingclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Otwórz ponownie udostępniany dashboard poleceniem marketingclaw dashboard, aby UI i Gateway pochodziły z tej samej instalacji.",
        stepDevUi:
          "Jeśli używasz pnpm ui:dev, przebuduj lub uruchom ponownie UI dev względem bieżącego checkoutu.",
        stepRestart:
          "Zrestartuj Gateway po aktualizacji MarketingClaw, aby udostępniał bieżący protokół.",
      },
      network: {
        ...
        stepGateway:
          "Potwierdź, że Gateway działa, używając marketingclaw status lub marketingclaw gateway run.",
        stepUrl: "Sprawdź URL WebSocket i użyj wss://, gdy Gateway jest za HTTPS/Tailscale Serve.",
        stepDashboard:
          "Otwórz ponownie dashboard przez marketingclaw dashboard --no-open, aby skopiować bieżący URL i szczegóły auth.",
      },
    },
  },
  connection: {
