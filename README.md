# 🦞 MarketingClaw — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/marketingclaw-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/marketingclaw-logo-text.svg" alt="MarketingClaw" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/promisingcoder/marketingclaw/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/marketingclaw/marketingclaw/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/promisingcoder/marketingclaw/releases"><img src="https://img.shields.io/github/v/release/marketingclaw/marketingclaw?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**MarketingClaw** is a _personal AI assistant_ you run on your own devices.
...
[Website](https://marketingclaw.ai) · [Docs](https://docs.marketingclaw.ai) · [Vision](VISION.md) · [Third-party notices](THIRD_PARTY_NOTICES.md) · [DeepWiki](https://deepwiki.com/openclaw/openclaw) · [Getting Started](https://docs.marketingclaw.ai/start/getting-started) · [Updating](https://docs.marketingclaw.ai/install/updating) · [Showcase](https://docs.marketingclaw.ai/start/showcase) · [FAQ](https://docs.marketingclaw.ai/help/faq) · [Onboarding](https://docs.marketingclaw.ai/start/wizard) · [Nix](https://github.com/openclaw/nix-openclaw) · [Docker](https://docs.marketingclaw.ai/install/docker) · [Discord](https://discord.gg/clawd)

New install? Start here: [Getting started](https://docs.marketingclaw.ai/start/getting-started)

Preferred setup: run `marketingclaw onboard` in your terminal.
MarketingClaw Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows**.
Windows desktop users can start with the native [Windows Hub](https://docs.marketingclaw.ai/platforms/windows) companion app for setup, tray status, chat, node mode, and local MCP mode.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/promisingcoder/marketingclaw/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See [Onboarding](https://docs.marketingclaw.ai/start/wizard).
...
MarketingClaw Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.19+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.marketingclaw.ai/start/getting-started)
...
```bash
# Send a message
marketingclaw message send --target +1234567890 --message "Hello from MarketingClaw"
...
marketingclaw agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.marketingclaw.ai/install/updating) (and run `marketingclaw doctor`).

Models config + CLI: [Models](https://docs.marketingclaw.ai/concepts/models). Auth profile rotation + fallbacks: [Model failover](https://docs.marketingclaw.ai/concepts/model-failover).

## Security defaults (DM access)

MarketingClaw connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.marketingclaw.ai/gateway/security).
Before remote exposure, use the [Gateway exposure runbook](https://docs.marketingclaw.ai/gateway/security/exposure-runbook).

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `marketingclaw pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `marketingclaw doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.marketingclaw.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.marketingclaw.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.marketingclaw.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.marketingclaw.ai/nodes/voicewake) + [Talk Mode](https://docs.marketingclaw.ai/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.marketingclaw.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.marketingclaw.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.marketingclaw.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.marketingclaw.ai/platforms)** — Windows Hub, macOS menu bar app, and iOS/Android [nodes](https://docs.marketingclaw.ai/nodes).
- **[Onboarding](https://docs.marketingclaw.ai/start/wizard) + [skills](https://docs.marketingclaw.ai/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.
...
- Before exposing anything remotely, read [Security](https://docs.marketingclaw.ai/gateway/security), [Gateway exposure runbook](https://docs.marketingclaw.ai/gateway/security/exposure-runbook), [Sandboxing](https://docs.marketingclaw.ai/gateway/sandboxing), and [Configuration](https://docs.marketingclaw.ai/gateway/configuration).
...
- Architecture overview: [Architecture](https://docs.marketingclaw.ai/concepts/architecture)

## Docs by goal

- New here: [Getting started](https://docs.marketingclaw.ai/start/getting-started), [Onboarding](https://docs.marketingclaw.ai/start/wizard), [Updating](https://docs.marketingclaw.ai/install/updating)
- Channel setup: [Channels index](https://docs.marketingclaw.ai/channels), [WhatsApp](https://docs.marketingclaw.ai/channels/whatsapp), [Telegram](https://docs.marketingclaw.ai/channels/telegram), [Discord](https://docs.marketingclaw.ai/channels/discord), [Slack](https://docs.marketingclaw.ai/channels/slack)
- Apps + nodes: [Windows Hub](https://docs.marketingclaw.ai/platforms/windows), [macOS](https://docs.marketingclaw.ai/platforms/macos), [iOS](https://docs.marketingclaw.ai/platforms/ios), [Android](https://docs.marketingclaw.ai/platforms/android), [Nodes](https://docs.marketingclaw.ai/nodes)
- Config + security: [Configuration](https://docs.marketingclaw.ai/gateway/configuration), [Security](https://docs.marketingclaw.ai/gateway/security), [Exposure runbook](https://docs.marketingclaw.ai/gateway/security/exposure-runbook), [Sandboxing](https://docs.marketingclaw.ai/gateway/sandboxing)
- Remote + web: [Gateway](https://docs.marketingclaw.ai/gateway), [Remote access](https://docs.marketingclaw.ai/gateway/remote), [Tailscale](https://docs.marketingclaw.ai/gateway/tailscale), [Web surfaces](https://docs.marketingclaw.ai/web)
- Tools + automation: [Tools](https://docs.marketingclaw.ai/tools), [Skills](https://docs.marketingclaw.ai/tools/skills), [Cron jobs](https://docs.marketingclaw.ai/automation/cron-jobs), [Webhooks](https://docs.marketingclaw.ai/automation/webhook), [Gmail Pub/Sub](https://docs.marketingclaw.ai/automation/gmail-pubsub)
- Internals: [Architecture](https://docs.marketingclaw.ai/concepts/architecture), [Agent](https://docs.marketingclaw.ai/concepts/agent), [Session model](https://docs.marketingclaw.ai/concepts/session), [Gateway protocol](https://docs.marketingclaw.ai/reference/rpc)
- Troubleshooting: [Channel troubleshooting](https://docs.marketingclaw.ai/channels/troubleshooting), [Logging](https://docs.marketingclaw.ai/logging), [Docs home](https://docs.marketingclaw.ai)
...
### macOS (MarketingClaw.app) (optional)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.marketingclaw.ai/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `marketingclaw nodes …`.

Runbook: [iOS connect](https://docs.marketingclaw.ai/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`marketingclaw devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.marketingclaw.ai/platforms/android).
...
# First run only (or after resetting local MarketingClaw config/workspace)
pnpm marketingclaw setup
...
`pnpm marketingclaw setup` writes the local config/workspace needed for `pnpm gateway:watch`. It is safe to re-run, but you normally only need it on first setup or after resetting local state. `pnpm gateway:watch` does not rebuild `dist/control-ui`, so rerun `pnpm ui:build` after `ui/` changes or use `pnpm ui:dev` when iterating on the Control UI. If you want this checkout to run onboarding directly, use `pnpm marketingclaw onboard --install-daemon`.

Note: `pnpm marketingclaw ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `marketingclaw` binary, while `pnpm gateway:watch` rebuilds the runtime on demand during the dev loop.
...
Switch channels (git + npm): `marketingclaw update --channel stable|beta|dev`.
Details: [Development channels](https://docs.marketingclaw.ai/install/development-channels).

## Agent workspace + skills

- Workspace root: `~/.marketingclaw/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.marketingclaw/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.marketingclaw/marketingclaw.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.marketingclaw.ai/gateway/configuration)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=marketingclaw/marketingclaw&type=date&legend=top-left)](https://www.star-history.com/#marketingclaw/marketingclaw&type=date&legend=top-left)

## Molty

MarketingClaw was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [marketingclaw.ai](https://marketingclaw.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@marketingclaw](https://x.com/marketingclaw)

## Community

See [CONTRIBUTING.md](CONTRIBUTING.md) for guidelines, maintainers, and how to submit PRs.
Use the [issue chooser](https://github.com/promisingcoder/marketingclaw/issues/new/choose) for bugs, docs bugs, and feature requests;
