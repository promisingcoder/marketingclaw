...
- Code: `.agents/skills/marketingclaw-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/marketingclaw-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
