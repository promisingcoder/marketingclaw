...
`precise.yml` is MarketingClaw's shipped precise OpenGrep rulepack. Each rule is tied
...
Some MarketingClaw paths are excluded by `.gitignore` for build reasons even though
