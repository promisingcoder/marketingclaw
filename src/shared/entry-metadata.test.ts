...
describe("shared/entry-metadata", () => {
  it("prefers metadata emoji and homepage when present", () => {
    expect(
      resolveEmojiAndHomepage({
        metadata: { emoji: "🦀", homepage: " https://marketingclaw.ai " },
  ...
  it("falls back through frontmatter homepage aliases and drops blanks", () => {
    expect(
      resolveEmojiAndHomepage({
        frontmatter: { emoji: "🙂", website: " https://docs.marketingclaw.ai " },
      }),
    ).toEqual({
      emoji: "🙂",
    ...
    expect(
      resolveEmojiAndHomepage({
        frontmatter: { url: " https://marketingclaw.ai/install " },
      }),
    ).toEqual({
      homepage: "https://marketingclaw.ai/install",
    });
  });
    ...
    expect(
      resolveEmojiAndHomepage({
        frontmatter: {
          ...
          url: "https://marketingclaw.ai/install",
        },
      }),
    ).toStrictEqual({});
  });
