...
describe("runtime-import", () => {
  ...
  it("resolves runtime imports from Windows absolute base paths", () => {
    ...
    expect(
      resolveRuntimeImportSpecifier("C:\\Users\\alice\\marketingclaw\\dist\\subagent-registry.js", [
        "./subagent-registry.runtime.js",
      ]),
    ).toBe("file:///C:/Users/alice/marketingclaw/dist/subagent-registry.runtime.js");
  });
  ...
  it("resolves runtime imports from file URL base paths", () => {
    ...
    expect(
      resolveRuntimeImportSpecifier(
        "file:///C:/Users/alice/marketingclaw/dist/subagent-registry.js",
        ["./subagent-registry.runtime.js"],
      ),
    ).toBe("file:///C:/Users/alice/marketingclaw/dist/subagent-registry.runtime.js");
  });
  ...
  it("resolves absolute Windows runtime import parts directly", () => {
    ...
    expect(
      resolveRuntimeImportSpecifier(
        "file:///C:/Users/alice/marketingclaw/dist/subagent-registry.js",
        ["D:\\MarketingClaw\\dist\\subagent-registry.runtime.js"],
      ),
    ).toBe("file:///D:/MarketingClaw/dist/subagent-registry.runtime.js");
  });
  ...
  it("imports with the normalized runtime specifier", async () => {
    ...
    const result = await importRuntimeModule(
      "C:\\Users\\alice\\marketingclaw\\dist\\subagent-registry.js",
      ["./subagent-registry.runtime.js"],
      importModule,
    );

    expect(importModule).toHaveBeenCalledWith(
      "file:///C:/Users/alice/marketingclaw/dist/subagent-registry.runtime.js",
    );
    expect(result).toEqual({
      specifier: "file:///C:/Users/alice/marketingclaw/dist/subagent-registry.runtime.js",
    });
  });
});
