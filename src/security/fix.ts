...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof MarketingClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: MarketingClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: MarketingClawConfig;
  changes: string[];
} {
