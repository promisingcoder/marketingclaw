...
import { parseBoolean } from "@marketingclaw/normalization-core/boolean-coercion";
...
export const LEGACY_MEMORY_LIGHT_DREAMING_EVENT_TEXT = "__marketingclaw_memory_core_light_sleep__";
...
export const LEGACY_MEMORY_REM_DREAMING_EVENT_TEXT = "__marketingclaw_memory_core_rem_sleep__";
...
export function resolveMemoryDreamingPluginId(
  cfg: MarketingClawConfig | Record<string, unknown> | undefined,
): string {
