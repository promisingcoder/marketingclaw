...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  [bundledPluginFile({
    ...
    'export type { MarketingClawPluginServiceContext } from "./api.js";',
  ],
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin } from "marketingclaw/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "marketingclaw/plugin-sdk/status-helpers";',
      'export { formatTrimmedAllowFromEntries } from "marketingclaw/plugin-sdk/channel-config-helpers";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiMarketingClawConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [bundledPluginFile({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "marketingclaw/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema } from "marketingclaw/plugin-sdk/channel-config-primitives";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "marketingclaw/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "marketingclaw/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "marketingclaw/plugin-sdk/channel-outbound";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "marketingclaw/plugin-sdk/runtime-group-policy";',
    'export { isDangerousNameMatchingEnabled } from "marketingclaw/plugin-sdk/dangerous-name-runtime";',
    'export { readRemoteMediaBuffer, resolveChannelMediaMaxBytes } from "marketingclaw/plugin-sdk/media-runtime";',
    ...
    'export type { GoogleChatAccountConfig, GoogleChatConfig } from "marketingclaw/plugin-sdk/config-contracts";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "marketingclaw/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "marketingclaw/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "msteams", relativePath: "runtime-api.ts" })]: [
    ...
    'export { mergeAllowlist, resolveAllowlistMatchSimple, summarizeMapping } from "marketingclaw/plugin-sdk/allow-from";',
    'export type { BaseProbeResult, ChannelDirectoryEntry, ChannelGroupContext, ChannelMessageActionName, ChannelOutboundAdapter } from "marketingclaw/plugin-sdk/channel-contract";',
    ...
    'export { createChannelMessageReplyPipeline } from "marketingclaw/plugin-sdk/channel-outbound";',
    'export { PAIRING_APPROVED_MESSAGE, buildProbeChannelStatusSummary, createDefaultChannelRuntimeState } from "marketingclaw/plugin-sdk/channel-status";',
    'export { buildChannelKeyCandidates, normalizeChannelSlug, resolveChannelEntryMatchWithFallback, resolveNestedAllowlistDecision } from "marketingclaw/plugin-sdk/channel-targets";',
    'export type { GroupPolicy, GroupToolPolicyConfig, MSTeamsChannelConfig, MSTeamsCloudName, MSTeamsConfig, MSTeamsReplyStyle, MSTeamsTeamConfig, MarkdownTableMode, MarketingClawConfig } from "marketingclaw/plugin-sdk/config-contracts";',
    'export { isDangerousNameMatchingEnabled } from "marketingclaw/plugin-sdk/dangerous-name-runtime";',
    ...
    'export { detectMime, extensionForMime, extractOriginalFilename, getFileExtension, resolveChannelMediaMaxBytes } from "marketingclaw/plugin-sdk/media-runtime";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "marketingclaw/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext } from "marketingclaw/plugin-sdk/channel-contract";',
    'export type { MarketingClawConfig } from "marketingclaw/plugin-sdk/config-contracts";',
    ...
    'export type { RuntimeEnv } from "marketingclaw/plugin-sdk/runtime-env";',
  ...
  [bundledPluginFile({
    ...
    'export { createChannelPairingController } from "marketingclaw/plugin-sdk/channel-pairing";',
    'export type { BlockStreamingCoalesceConfig, DmConfig, DmPolicy, GroupPolicy, GroupToolPolicyConfig, MarketingClawConfig } from "marketingclaw/plugin-sdk/config-contracts";',
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "marketingclaw/plugin-sdk/runtime-group-policy";',
    'export { createChannelMessageReplyPipeline } from "marketingclaw/plugin-sdk/channel-outbound";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export type { MarketingClawPluginService, MarketingClawPluginServiceContext, PluginLogger } from "marketingclaw/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "marketingclaw/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "marketingclaw/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "marketingclaw/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "marketingclaw/plugin-sdk/channel-plugin-common";',
      ...
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "marketingclaw/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "marketingclaw/plugin-sdk/channel-actions";',
      ...
      'export type { ChannelPlugin } from "marketingclaw/plugin-sdk/channel-core";',
      'export type { MarketingClawConfig } from "marketingclaw/plugin-sdk/config-contracts";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeMarketingClawConfig["channels"]>["telegram"] >;',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "twitch", relativePath: "runtime-api.ts" })]: [
    'export type { ChannelAccountSnapshot, ChannelCapabilities, ChannelGatewayContext, ChannelLogSink, ChannelMessageActionAdapter, ChannelMessageActionContext, ChannelMeta, ChannelOutboundAdapter, ChannelOutboundContext, ChannelResolveKind, ChannelResolveResult, ChannelStatusAdapter } from "marketingclaw/plugin-sdk/channel-contract";',
    'export type { ChannelPlugin } from "marketingclaw/plugin-sdk/channel-core";',
  ...
  [bundledPluginFile({
    ...
    'export { isRequestBodyLimitError, readRequestBodyWithLimit, requestBodyErrorToText } from "marketingclaw/plugin-sdk/webhook-request-guards";',
    ...
    'export { TtsAutoSchema, TtsConfigSchema, TtsModeSchema, TtsProviderSchema } from "marketingclaw/plugin-sdk/tts-runtime";',
...
describe("runtime api guardrails", () => {
  ...
  it("keeps bundled runtime api barrels off their own branded sdk facades", () => {
    for (const [pluginId, rootDir] of getBundledPluginRoots().entries()) {
      ...
      ).not.toContain(`"marketingclaw/plugin-sdk/${pluginId}"`);
      expect(
        source,
        `${pluginId} runtime api should use generic sdk subpaths or local exports`,
      ).not.toContain(`'marketingclaw/plugin-sdk/${pluginId}'`);
