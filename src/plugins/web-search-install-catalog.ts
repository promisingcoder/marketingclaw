...
import { normalizeOptionalString as normalizeString } from "@marketingclaw/normalization-core/string-coerce";
...
function getConfigPath(config: MarketingClawConfig | undefined, path: string): unknown {
...
function setConfigPath(target: MarketingClawConfig, path: string, value: unknown): void {
...
function buildProviderEntry(params: {
  ...
  return {
    ...
    getConfiguredCredentialValue: (config?: MarketingClawConfig) =>
      getConfigPath(config, credentialPath),
    setConfiguredCredentialValue: (configTarget: MarketingClawConfig, value: unknown) => {
      setConfigPath(configTarget, credentialPath, value);
    },
    applySelectionConfig: (config: MarketingClawConfig) =>
