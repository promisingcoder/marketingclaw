...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by MarketingClaw from plugin manifests, install records, and config policy. Use `marketingclaw plugins registry --refresh`, `marketingclaw plugins install/update/uninstall`, or `marketingclaw plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored marketingclaw.install metadata. This describes catalog/package
