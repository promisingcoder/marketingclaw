...
import type { MarketingClawPluginToolContext } from "../tool-types.js";
...
export type BoundTaskRunsRuntime = {
  ...
  cancel: (params: { taskId: string; cfg: MarketingClawConfig }) => Promise<TaskRunCancelResult>;
};
...
export type PluginRuntimeTaskRuns = {
  ...
  fromToolContext: (
    ctx: Pick<MarketingClawPluginToolContext, "sessionKey" | "deliveryContext">,
  ) => BoundTaskRunsRuntime;
};
