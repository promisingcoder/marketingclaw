...
function resolveMemoryRuntimePluginIds(config: MarketingClawConfig): string[] {
...
function resolveMemoryRuntimeWorkspaceDir(cfg: MarketingClawConfig): string | undefined {
...
function ensureMemoryRuntime(cfg?: MarketingClawConfig) {
...
export async function closeActiveMemorySearchManagers(cfg?: MarketingClawConfig): Promise<void> {
  void cfg;
