...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: MarketingClawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: MarketingClawConfig): AcpManagerObservabilitySnapshot {
  ...
  private async evictIdleRuntimeHandles(cfg: MarketingClawConfig): Promise<void> {
