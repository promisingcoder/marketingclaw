// Projects ACP runtime events into MarketingClaw-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@marketingclaw/acp-core/runtime/types";
import {
