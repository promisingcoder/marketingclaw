...
import { toAcpRuntimeErrorText } from "@marketingclaw/acp-core/runtime/error-text";
...
export function resolveAcpHelpText(): string {
  return [
    ...
    "",
    "Notes:",
    "- /acp spawn harness-id is an ACP runtime harness alias (for example codex), not an MarketingClaw agents.list id.",
