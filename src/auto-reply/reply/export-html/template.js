...
(function () {
  ...
  const injectedParams = document.querySelector('meta[name="marketingclaw-url-params"]');
  ...
  function buildShareUrl(entryId) {
    ...
    const baseUrlMeta = document.querySelector('meta[name="marketingclaw-share-base-url"]');
