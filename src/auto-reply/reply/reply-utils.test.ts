...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bmarketingclaw\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: { identityName: "MarketingClaw" },
        expected: "[MarketingClaw]",
      },
      {
      ...
      },
      {
        ...
        values: {
          identityName: "MarketingClaw",
          provider: "anthropic",
          model: "claude-opus-4-6",
          thinkingLevel: "high",
        },
        expected: "[MarketingClaw] anthropic/claude-opus-4-6 (think:high)",
      },
    ] as const;
