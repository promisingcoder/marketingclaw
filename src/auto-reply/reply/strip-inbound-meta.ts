/**
 * Strips MarketingClaw-injected inbound metadata blocks from a user-role message
...
export function stripInboundMetadata(text: string): string {
  ...
  for (let i = 0; i < strippedLeadingPrefixLines.length; i++) {
    ...
    // Channel untrusted context is appended by MarketingClaw as a terminal metadata suffix.
