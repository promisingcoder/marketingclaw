// Product/package naming constants that bridge current MarketingClaw manifests with
// legacy Clawdbot keys still seen in older configs and packages.
export const PROJECT_NAME = "marketingclaw" as const;
...
export const MACOS_APP_SOURCES_DIR = "apps/macos/Sources/MarketingClaw" as const;
