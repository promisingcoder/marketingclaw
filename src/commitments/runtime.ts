...
type CommitmentExtractionRuntime = {
  ...
  resolveDefaultModel?: (params: { cfg: MarketingClawConfig; agentId?: string }) => ModelRef;
...
let queue: Array<
  Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: MarketingClawConfig }
> = [];
...
async function hydrateBatch(
  batch: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: MarketingClawConfig }>,
