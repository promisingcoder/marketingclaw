...
import { normalizeOptionalString as asString } from "@marketingclaw/normalization-core/string-coerce";
...
export function buildCommitmentExtractionPrompt(params: {
  ...
  return `You are MarketingClaw's internal commitment extractor. This is a hidden background classification run. Do not address the user.
