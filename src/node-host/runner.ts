...
type NodeHostRunOptions = {
  ...
  /** Optional WebSocket context path (e.g. "/marketclaw-gw"). */
...
function ensureNodePathEnv(): string {
  ensureMarketingClawCliOnPath({ pathEnv: process.env.PATH ?? "" });
...
function buildNodeHostLocalAuthConfig(config: MarketingClawConfig): MarketingClawConfig {
