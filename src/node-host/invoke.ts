...
const execHostEnforced =
  normalizeLowercaseStringOrEmpty(process.env.MARKETINGCLAW_NODE_EXEC_HOST ?? "") === "app";
const execHostFallbackAllowed =
  normalizeLowercaseStringOrEmpty(process.env.MARKETINGCLAW_NODE_EXEC_FALLBACK ?? "") !== "0";
