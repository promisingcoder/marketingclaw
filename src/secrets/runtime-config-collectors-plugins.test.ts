...
function makeContext(sourceConfig: MarketingClawConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: MarketingClawConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: MarketingClawConfig): void {
