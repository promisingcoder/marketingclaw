...
function toCandidate(
  ...
  defaults: NonNullable<MarketingClawConfig["secrets"]>["defaults"] | undefined,
 ...
 */
export function migrateLegacySecretRefEnvMarkers(config: MarketingClawConfig): {
  config: MarketingClawConfig;
  changes: string[];
} {
  ...
  const next = structuredClone(config) as MarketingClawConfig & Record<string, unknown>;
