...
import { normalizeModelCatalogProviderRows } from "@marketingclaw/model-catalog-core/model-catalog-normalize";
...
import type { MarketingClawProviderIndex } from "./provider-index/index.js";
...
export function planProviderIndexModelCatalogRows(params: {
  index: MarketingClawProviderIndex;
