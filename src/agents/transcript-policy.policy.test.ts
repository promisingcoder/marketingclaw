...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.MARKETINGCLAW_SKIP_PROVIDERS;
  delete env.MARKETINGCLAW_SKIP_CHANNELS;
  delete env.MARKETINGCLAW_SKIP_CRON;
  delete env.MARKETINGCLAW_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
