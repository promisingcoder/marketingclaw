...
describe("splitSdkTools", () => {
  ...
  it("keeps MarketingClaw-managed custom tools in MarketingClaw runtime's session allowlist", () => {
    // Session tools are MarketingClaw-managed custom tools; dropping them from the
