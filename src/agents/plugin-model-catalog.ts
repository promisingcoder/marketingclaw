...
export const PLUGIN_MODEL_CATALOG_GENERATED_BY = "marketingclaw-plugin-model-catalog-v1";
...
/** Detects model catalogs generated by MarketingClaw rather than user-authored JSON. */
