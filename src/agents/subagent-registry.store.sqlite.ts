...
type SubagentRunsTable = MarketingClawStateKyselyDatabase["subagent_runs"];
type SubagentRegistryDatabase = Pick<MarketingClawStateKyselyDatabase, "subagent_runs">;
