...
export function createAgentToolsSandboxContext(
  ...
  return {
    ...
    runtimeId: params.containerName ?? "marketingclaw-sbx-test",
    runtimeLabel: params.containerName ?? "marketingclaw-sbx-test",
    containerName: params.containerName ?? "marketingclaw-sbx-test",
