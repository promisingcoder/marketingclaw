 ...
 * pairs directly into the provider payload, so MarketingClaw must normalize here.
 */
 ...
 *
 * MarketingClaw persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
