 ...
 */
import { resolveOptionalIntegerOption } from "@marketingclaw/normalization-core/number-coercion";
...
const AGENT_CLEANUP_STEP_TIMEOUT_ENV = "MARKETINGCLAW_AGENT_CLEANUP_TIMEOUT_MS";
const TRAJECTORY_FLUSH_TIMEOUT_ENV = "MARKETINGCLAW_TRAJECTORY_FLUSH_TIMEOUT_MS";
...
function resolveAgentCleanupStepTimeoutMs(params: {
  ...
  if (params.step === "marketingclaw-trajectory-flush") {
