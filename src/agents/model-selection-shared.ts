...
function listModelAliasCandidates(cfg: MarketingClawConfig): ModelAliasCandidate[] {
...
export function hasConfiguredProviderModelRows(cfg: MarketingClawConfig): boolean {
...
export function parseConfiguredModelVisibilityEntries(params: { cfg?: MarketingClawConfig }): {
