...
export const CLI_BACKEND_LOG_OUTPUT_ENV = "MARKETINGCLAW_CLI_BACKEND_LOG_OUTPUT";
/** Legacy env var accepted for Claude CLI output logging. */
export const LEGACY_CLAUDE_CLI_LOG_OUTPUT_ENV = "MARKETINGCLAW_CLAUDE_CLI_LOG_OUTPUT";
