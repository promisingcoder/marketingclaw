...
import type { UserMessage } from "marketingclaw/plugin-sdk/llm";
...
vi.mock("marketingclaw/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof import("marketingclaw/plugin-sdk/agent-sessions")>(
    "marketingclaw/plugin-sdk/agent-sessions",
  );
  return {
    ...actual,
