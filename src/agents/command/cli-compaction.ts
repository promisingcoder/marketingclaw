...
import { MARKETINGCLAW_AGENT_RUNTIME_ID } from "../agent-runtime-id.js";
...
type CliCompactionDeps = {
  ...
  resolveContextEngine: (cfg: MarketingClawConfig) => Promise<ContextEngine>;
...
function isNativeHarnessCompactionSession(
  ...
  if (!harnessId || normalizeOptionalAgentRuntimeId(harnessId) === MARKETINGCLAW_AGENT_RUNTIME_ID) {
    return false;
  }
