...
export const DEFAULT_SANDBOX_IMAGE = "marketingclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "marketingclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "marketingclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "marketingclaw-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "marketingclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "marketingclaw-sandbox-browser";
