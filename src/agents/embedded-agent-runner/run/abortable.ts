...
export const MARKETINGCLAW_ABORTABLE_WRAPPER = Symbol.for("marketingclaw.abortable.wrapper");

export function isMarketingClawAbortableWrapper(err: unknown): boolean {
  return err !== null && typeof err === "object" && MARKETINGCLAW_ABORTABLE_WRAPPER in err;
}

function tagAsAbortableWrapper(err: Error): Error {
  (err as Error & { [MARKETINGCLAW_ABORTABLE_WRAPPER]?: true })[MARKETINGCLAW_ABORTABLE_WRAPPER] =
    true;
  return err;
}
