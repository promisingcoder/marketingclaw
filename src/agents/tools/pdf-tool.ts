...
function hasExplicitPdfToolModelConfig(config?: MarketingClawConfig): boolean {
  return (
...
async function runPdfPrompt(params: {
  ...
  await ensureMarketingClawModelsJson(effectiveCfg, params.agentDir, modelsOptions);
