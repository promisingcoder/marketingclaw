...
import type { MarketingClawSkillMetadata, SkillEntry } from "../types.js";
...
const fixtureSuite = createFixtureSuite("marketingclaw-skills-prompt-suite-");
...
function createSkillEntry(params: {
  name: string;
  description?: string;
  metadata?: MarketingClawSkillMetadata;
}): SkillEntry {
