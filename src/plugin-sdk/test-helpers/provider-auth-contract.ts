...
type EnsureAuthProfileStore =
  typeof import("marketingclaw/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("marketingclaw/plugin-sdk/provider-auth").listProfilesForProvider;
...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("marketingclaw/plugin-sdk/provider-auth", async () => {
