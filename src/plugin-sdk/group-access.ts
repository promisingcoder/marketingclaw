...
/** @deprecated Use `resolveChannelMessageIngress` from `marketingclaw/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `marketingclaw/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `marketingclaw/plugin-sdk/channel-ingress-runtime`. */
