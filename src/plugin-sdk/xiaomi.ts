...
type FacadeModule = {
  applyXiaomiConfig: (cfg: MarketingClawConfig) => MarketingClawConfig;
  applyXiaomiProviderConfig: (cfg: MarketingClawConfig) => MarketingClawConfig;
...
/** Apply Xiaomi provider defaults to the full MarketingClaw config. */
