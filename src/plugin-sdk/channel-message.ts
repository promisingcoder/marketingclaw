/**
 * @deprecated Use `marketingclaw/plugin-sdk/channel-outbound` for outbound/message
 * lifecycle helpers and `marketingclaw/plugin-sdk/channel-inbound` for inbound
...
/** @deprecated Use `hasFinalInboundReplyDispatch(...)` from `marketingclaw/plugin-sdk/channel-inbound`. */
export { hasFinalChannelTurnDispatch } from "../channels/turn/dispatch-result.js";
/** @deprecated Use `hasVisibleInboundReplyDispatch(...)` from `marketingclaw/plugin-sdk/channel-inbound`. */
export { hasVisibleChannelTurnDispatch } from "../channels/turn/dispatch-result.js";
/** @deprecated Use `resolveInboundReplyDispatchCounts(...)` from `marketingclaw/plugin-sdk/channel-inbound`. */
export { resolveChannelTurnDispatchCounts } from "../channels/turn/dispatch-result.js";

/** @deprecated Use `createChannelMessageReplyPipeline(...)` from `marketingclaw/plugin-sdk/channel-outbound`. */
...
/** @deprecated Use `buildInboundReplyDispatchBase(...)` from `marketingclaw/plugin-sdk/channel-inbound`. */
export { buildChannelMessageReplyDispatchBase } from "./inbound-reply-dispatch.js";
/** @deprecated Use `dispatchChannelInboundReply(...)` or `runPreparedInboundReply(...)` from `marketingclaw/plugin-sdk/channel-inbound`. */
...
/** @deprecated Use `deliverInboundReplyWithMessageSendContext(...)` from `marketingclaw/plugin-sdk/channel-outbound`. */
