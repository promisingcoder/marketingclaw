...
export const toolPluginMetadataSymbol = Symbol.for("marketingclaw.plugin-sdk.tool-plugin.metadata");

/** Runtime context supplied to a concrete tool plugin execution handler. */
export type ToolPluginExecutionContext = {
  /** Plugin runtime API for tool implementations that need MarketingClaw services. */
