...
export type { MarketingClawConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: MarketingClawConfig, ...args: TArgs) => MarketingClawConfig;
  applyConfig: (cfg: MarketingClawConfig, ...args: TArgs) => MarketingClawConfig;
};
...
function hasAgentDefaultModelPrimary(cfg: MarketingClawConfig): boolean {
...
>(params: {
  ...
  applyPreset: (cfg: MarketingClawConfig, preset: TParams) => MarketingClawConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: MarketingClawConfig): {
