 ...
 * `marketingclaw/plugin-sdk/runtime` and lower-level secret helpers from
 * `marketingclaw/plugin-sdk/secret-ref-runtime` instead.
 */

/** @deprecated Import from `marketingclaw/plugin-sdk/runtime` instead. */
export { resolveCommandSecretRefsViaGateway } from "../cli/command-secret-gateway.js";
/** @deprecated Import from `marketingclaw/plugin-sdk/runtime` instead. */
export { getChannelsCommandSecretTargetIds } from "../cli/command-secret-targets.js";
/** @deprecated Import from `marketingclaw/plugin-sdk/secret-ref-runtime` instead. */
