 ...
 * older broad plugin-sdk imports. Use focused marketingclaw/plugin-sdk subpaths
 * instead.
 */
...
const shouldWarnCompatImport =
  ...
  process.env.MARKETINGCLAW_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "marketingclaw/plugin-sdk/compat is deprecated for new plugins. Migrate to focused marketingclaw/plugin-sdk/<subpath> imports. See https://docs.marketingclaw.ai/plugins/sdk-migration",
    {
      code: "MARKETINGCLAW_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.marketingclaw.ai/plugins/sdk-migration",
    },
  );
}
...
export { resolvePreferredMarketingClawTmpDir } from "./temp-path.js";
...
/** @deprecated Use `marketingclaw/plugin-sdk/channel-outbound`. */
