/**
 * @deprecated Use `marketingclaw/plugin-sdk/channel-inbound` for inbound runners and
 * dispatch predicates. Use `marketingclaw/plugin-sdk/channel-outbound` for message
 * delivery helpers.
 */
