...
const FACADE_LOADER_GLOBAL = "__marketingclawTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    const pluginId = nextTrustedPluginId("marketingclaw-facade-loader-override-");
    const overrideA = createBundledPluginFixture({
      pluginId,
      kind: "dist",
      prefix: "marketingclaw-facade-loader-a-",
      marker: "override-a",
    });
    const overrideB = createBundledPluginFixture({
      pluginId,
      kind: "dist-runtime",
      prefix: "marketingclaw-facade-loader-b-",
      marker: "override-b",
    });

    process.env.MARKETINGCLAW_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.MARKETINGCLAW_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    const fixture = createPackageSourcePluginFixture({
      prefix: "marketingclaw-facade-loader-source-fallback-",
      marker: "source-fallback",
    });
    process.env.MARKETINGCLAW_BUNDLED_PLUGINS_DIR = createTempDirSync(
      "marketingclaw-facade-loader-empty-",
    );
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const fixture = createBundledPluginFixture({
      prefix: "marketingclaw-facade-loader-ids-",
      marker: "identity-check",
    });
    process.env.MARKETINGCLAW_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("uses native require for Windows dist facade loads", () => {
    const fixture = createBundledPluginFixture({
      prefix: "marketingclaw-facade-loader-windows-",
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const fixture = createCircularPluginFixture("marketingclaw-facade-loader-circular-");
    process.env.MARKETINGCLAW_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const fixture = createThrowingPluginFixture("marketingclaw-facade-loader-throw-");
    process.env.MARKETINGCLAW_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
