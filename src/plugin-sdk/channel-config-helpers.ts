...
type ChannelConfigAccessorParams<Config extends MarketingClawConfig = MarketingClawConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends MarketingClawConfig = MarketingClawConfig,
> = {
  sectionKey: string;
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: MarketingClawConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends MarketingClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends MarketingClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends MarketingClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
