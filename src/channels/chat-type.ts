 ...
 *
 * Maps channel-specific direct/group/channel labels into MarketingClaw chat types.
 */
...
/**
 * Normalizes channel-specific chat type labels into MarketingClaw conversation kinds.
 */
