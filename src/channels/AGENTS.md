...
- Keep extension-facing channel surfaces flowing through `marketingclaw/plugin-sdk/*`
...
- For bundled plugin channel changes that can affect startup/import cost, run:
  `MARKETINGCLAW_LOCAL_CHECK=0 node scripts/profile-extension-memory.mjs --extension <id> --skip-combined --concurrency 1`
