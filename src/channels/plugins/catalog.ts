...
import type { MarketingClawPackageManifest } from "../../plugins/manifest.js";
...
function resolveOfficialCatalogPaths(options: CatalogOptions): string[] {
  ...
  const packageRoots = uniqueStrings(
    [
      resolveMarketingClawPackageRootSync({ cwd: process.cwd() }),
      resolveMarketingClawPackageRootSync({ moduleUrl: import.meta.url }),
...
function toChannelMeta(params: {
  channel: NonNullable<MarketingClawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
