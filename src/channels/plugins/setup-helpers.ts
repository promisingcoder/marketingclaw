...
function channelHasAccounts(cfg: MarketingClawConfig, channelKey: string): boolean {
...
export function createZodSetupInputValidator<T extends ChannelSetupInput>(params: {
  schema: ZodType<T>;
  validate?: (params: { cfg: MarketingClawConfig; accountId: string; input: T }) => string | null;
