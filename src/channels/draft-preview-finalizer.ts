...
/**
 * @deprecated Use `LivePreviewFinalizerDraft` from `marketingclaw/plugin-sdk/channel-outbound`.
 */
export type DraftPreviewFinalizerDraft<TId> = LivePreviewFinalizerDraft<TId>;

/**
 * @deprecated Use `LivePreviewFinalizerResult` from `marketingclaw/plugin-sdk/channel-outbound`.
 */
...
/**
 * @deprecated Use `deliverFinalizableLivePreview` from `marketingclaw/plugin-sdk/channel-outbound`.
 */
