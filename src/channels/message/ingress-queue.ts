 ...
 *
 * Stores, claims, completes, and tombstones inbound channel events in MarketingClaw state.
 */
...
import type {
  ...
  DB as MarketingClawStateKyselyDatabase,
} from "../../state/marketingclaw-state-db.generated.js";
import {
...
type ChannelIngressDatabase = Pick<MarketingClawStateKyselyDatabase, "channel_ingress_events">;
...
/** Creates a durable channel/account-scoped ingress queue backed by the MarketingClaw state database. */
