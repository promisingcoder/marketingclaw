...
export type ChannelMessageSendTextContext<TConfig = MarketingClawConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = MarketingClawConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = MarketingClawConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = MarketingClawConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = MarketingClawConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = MarketingClawConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = MarketingClawConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
...
export type ChannelMessageDeferredDeliveryAdmissionContext<TConfig = MarketingClawConfig> = {
  cfg: TConfig;
  channel: string;
  to: string;
  accountId?: string | null;
