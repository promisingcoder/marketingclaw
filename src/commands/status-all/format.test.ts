...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://marketingclaw.local")).toBe(
      "https://marketingclaw.local",
    );
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://marketingclaw.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: marketingclaw security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://marketingclaw.local" },
      ...
      { Item: "Security", Value: "Run: marketingclaw security audit --deep" },
