      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run marketingclaw plugins install @marketingclaw/feishu or marketingclaw doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run marketingclaw doctor --fix",
        },
      ],
      details: [],
    });
