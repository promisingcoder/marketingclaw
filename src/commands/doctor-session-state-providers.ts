...
import { normalizeStringEntriesLower } from "@marketingclaw/normalization-core/string-normalization";
...
function resolveSessionAgentId(cfg: MarketingClawConfig, sessionKey: string): string {
