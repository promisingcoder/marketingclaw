...
function collectToolAllowlistSources(cfg: MarketingClawConfig): ToolAllowlistSource[] {
...
function collectConfiguredMcpServerNames(cfg: MarketingClawConfig): string[] {
...
function collectSandboxMcpAllowlistWarnings(cfg: MarketingClawConfig): string[] {
