...
export function collectMissingDefaultAccountBindingWarnings(cfg: MarketingClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: MarketingClawConfig): string[] {
  const warnings: string[] = [];
