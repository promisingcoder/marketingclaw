...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV =
  "MARKETINGCLAW_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "MARKETINGCLAW_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<MarketingClawConfig> | MarketingClawConfig;
  };
...
function listConfiguredChannelIds(config: MarketingClawConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: MarketingClawConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as MarketingClawConfig;
