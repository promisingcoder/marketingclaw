...
const THREAD_BINDING_RULES: LegacyConfigRule[] = [
  {
    ...
    message:
      'session.threadBindings.ttlHours was renamed to session.threadBindings.idleHours. Run "marketingclaw doctor --fix".',
    match: (value) => hasLegacyThreadBindingTtl(value),
  },
  {
    path: ["channels"],
    message:
      'channels.<id>.threadBindings.ttlHours was renamed to channels.<id>.threadBindings.idleHours. Run "marketingclaw doctor --fix".',
    match: (value) => hasLegacyThreadBindingTtlInAnyChannel(value),
  },
  {
    path: ["session", "threadBindings"],
    message:
      'session.threadBindings.spawnSubagentSessions/spawnAcpSessions were replaced by session.threadBindings.spawnSessions. Run "marketingclaw doctor --fix".',
    match: (value) => hasLegacyThreadBindingSpawnSplit(value),
  },
  {
    path: ["channels"],
    message:
      'channels.<id>.threadBindings.spawnSubagentSessions/spawnAcpSessions were replaced by channels.<id>.threadBindings.spawnSessions. Run "marketingclaw doctor --fix".',
...
const GROUP_ROUTING_RULES: LegacyConfigRule[] = [
  {
    ...
    message:
      'routing.allowFrom was removed; use channels.whatsapp.allowFrom instead. Run "marketingclaw doctor --fix".',
  },
  {
    path: ["routing", "groupChat", "requireMention"],
    message:
      'routing.groupChat.requireMention was removed; use channels.<channel>.groups."*".requireMention instead. Run "marketingclaw doctor --fix".',
  },
  {
    path: ["routing", "groupChat", "historyLimit"],
    message:
      'routing.groupChat.historyLimit was moved; use messages.groupChat.historyLimit instead. Run "marketingclaw doctor --fix".',
  },
  {
    path: ["routing", "groupChat", "mentionPatterns"],
    message:
      'routing.groupChat.mentionPatterns was moved; use messages.groupChat.mentionPatterns instead. Run "marketingclaw doctor --fix".',
  },
  {
    path: ["channels", "telegram", "requireMention"],
    message:
      'channels.telegram.requireMention was removed; use channels.telegram.groups."*".requireMention instead. Run "marketingclaw doctor --fix".',
  },
];
...
const FEISHU_ACCOUNT_RULES: LegacyConfigRule[] = [
  {
    ...
    message:
      'channels.feishu.accounts.<id>.botName was renamed to channels.feishu.accounts.<id>.name. Run "marketingclaw doctor --fix".',
...
const WEBCHAT_CHANNEL_RULES: LegacyConfigRule[] = [
  {
    ...
    message: 'channels.webchat is retired. Run "marketingclaw doctor --fix".',
  },
];
