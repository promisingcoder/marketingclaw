...
export const UPDATE_IN_PROGRESS_ENV = "MARKETINGCLAW_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "MARKETINGCLAW_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `MARKETINGCLAW_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `MARKETINGCLAW_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */
