...
import { isMarketingClawOrgNpmSpec, parseRegistryNpmSpec } from "../infra/npm-registry-spec.js";
...
function shouldFallbackClawHubToNpm(params: {
  ...
  // Only official MarketingClaw npm packages are safe fallback targets for ClawHub
...
function addPluginLoadPath(cfg: MarketingClawConfig, pluginPath: string): MarketingClawConfig {
