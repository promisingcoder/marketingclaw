...
function listCommandForFallbackKey(key: DefaultsFallbackKey): string {
  return key === "imageModel"
    ? "marketingclaw models image-fallbacks list"
    : "marketingclaw models fallbacks list";
}

function getFallbacks(cfg: MarketingClawConfig, key: DefaultsFallbackKey): string[] {
