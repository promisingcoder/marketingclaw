...
export const MIGRATION_SELECTION_ACCEPT = "__marketingclaw_migrate_accept_recommended__";
export const MIGRATION_SELECTION_TOGGLE_ALL_ON = "__marketingclaw_migrate_toggle_all_on__";
export const MIGRATION_SELECTION_TOGGLE_ALL_OFF = "__marketingclaw_migrate_toggle_all_off__";
