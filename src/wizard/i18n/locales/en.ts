...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in MarketingClaw config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `marketingclaw doctor` next.",
    ...
    plugins: {
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  marketingclaw config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: MARKETINGCLAW_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in MarketingClaw config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in MarketingClaw config",
    ...
    guided: {
      ...
      complete: "MarketingClaw is ready.",
      ...
      escapeHatches:
        "For the full step-by-step wizard, run `marketingclaw onboard --classic`. You can open plain-language setup help anytime with `marketingclaw crestodian`.",
      ...
      invalidConfigCrestodian:
        "MarketingClaw config is invalid. Opening Crestodian to inspect and repair it before onboarding writes anything.",
      manualChoice: "How would you like to connect AI?",
      nextSteps:
        "Workspace: {workspace}\nAdd a channel: `marketingclaw channels add`\nPrefer chatting? Run `marketingclaw crestodian` and say `connect telegram` (or `connect slack`).\nOpen the dashboard: `marketingclaw dashboard`\nChat later: `marketingclaw`",
      ...
      skipAiLater:
        "To add AI later, set OPENAI_API_KEY or ANTHROPIC_API_KEY, or install and log into codex, claude, or gemini. Then re-run `marketingclaw onboard`.",
    ...
    security: {
      ...
      beta: "MarketingClaw is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run MarketingClaw.",
      learnMore: "Learn more",
      notMultitenant: "MarketingClaw is not a hostile multi-tenant boundary by default.",
      personalAgent:
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.marketingclaw.ai/skills",
      enterEnv: "Enter {env}",
      ...
      manualPrereqsDoctorHint:
        "Install those tools first, then run `marketingclaw doctor` to review skills + requirements.",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "MarketingClaw" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so MarketingClaw can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for MarketingClaw",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: marketingclaw channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies:
        "This is the URL MarketingClaw uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "MarketingClaw"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var MARKETINGCLAW_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: MARKETINGCLAW_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat:
          "Connect your Synology NAS Chat to MarketingClaw with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with marketingclaw configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.marketingclaw.ai/web/control-ui",
      dashboardCopyPaste:
        "Copy/paste this URL in a browser on this machine to control MarketingClaw.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control MarketingClaw.",
      ...
      gatewayTokenStored:
        "Stored in: $MARKETINGCLAW_CONFIG_PATH (default: ~/.marketingclaw/marketingclaw.json) under gateway.auth.token, or in MARKETINGCLAW_GATEWAY_TOKEN.",
      ...
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control MarketingClaw.",
      outroSeeded:
      ...
      containerSystemdUnavailable:
        "Systemd user services are not available inside this container. MarketingClaw is skipping only the background service install; run the Gateway in the foreground or use your container supervisor.",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.marketingclaw.ai/security",
      ...
      webDocs: "Docs: https://docs.marketingclaw.ai/tools/web",
      ...
      whatNow: 'What now: https://marketingclaw.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.marketingclaw.ai/concepts/agent-workspace",
