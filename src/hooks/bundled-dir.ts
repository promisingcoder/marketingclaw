...
export function resolveBundledHooksDir(): string | undefined {
  const override = process.env.MARKETINGCLAW_BUNDLED_HOOKS_DIR?.trim();
  if (override) {
    return override;
  }
  ...
  // This path works when installed via npm: node_modules/marketingclaw/dist/hooks/bundled-dir.js
  try {
