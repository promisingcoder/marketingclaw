/**
 * Hook system for MarketingClaw agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("marketingclaw.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("marketingclaw.internalHooksEnabled");
