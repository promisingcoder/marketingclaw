...
describe("post-install doctor result IPC", () => {
  ...
  it("rejects result paths outside the secure MarketingClaw temp root", async () => {
    const tempRoot = resolvePreferredMarketingClawTmpDir();
    const resultPath = path.join(
      `${tempRoot}-outside`,
      `marketingclaw-update-doctor-${process.pid}-00000000-0000-4000-8000-000000000000.json`,
    );
