...
import { canonicalizeBase64, estimateBase64DecodedBytes } from "@marketingclaw/media-core/base64";
import { basenameFromAnyPath } from "@marketingclaw/media-core/file-name";
