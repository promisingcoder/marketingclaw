// Resolves MarketingClaw update channels from config, tags, and versions.
...
/**
 * Env var carrying the *effective* update channel into `marketingclaw update finalize`
 ...
 * channel split (`MARKETINGCLAW_UPDATE_POST_CORE_CHANNEL` vs `…_REQUESTED_CHANNEL`).
 */
export const UPDATE_EFFECTIVE_CHANNEL_ENV = "MARKETINGCLAW_UPDATE_EFFECTIVE_CHANNEL";
...
/** Maps an MarketingClaw update channel to the npm dist-tag used for package lookups. */
