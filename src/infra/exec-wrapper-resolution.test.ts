...
describe("unwrapKnownDispatchWrapperInvocation", () => {
  test.each([
    ...
    {
      argv: ["flock", "-n", "/tmp/marketingclaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-en", "/tmp/marketingclaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-E", "1", "/tmp/marketingclaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-F", "/tmp/marketingclaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-o", "/tmp/marketingclaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "--nb", "/tmp/marketingclaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "--wait", "1", "/tmp/marketingclaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
    ...
    {
      argv: ["flock", "/tmp/marketingclaw.lock", "-c", "echo hi"],
      expected: { kind: "blocked", wrapper: "flock" },
    },
    {
      argv: ["flock", "-un", "/tmp/marketingclaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "blocked", wrapper: "flock" },
    },
    {
      argv: ["flock", "-u", "9"],
...
describe("resolveDispatchWrapperTrustPlan", () => {
  ...
  test.each([
    ...
    {
      argv: ["flock", "--timeout=2", "/tmp/marketingclaw.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {
      argv: ["flock", "--close", "/tmp/marketingclaw.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {
      argv: ["flock", "--no-fork", "/tmp/marketingclaw.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {
