...
export type DiscordVoiceRealtimeConfig = {
  ...
  /** Whether bidi should force the MarketingClaw agent brain for every substantive turn. */
  ...
  /** Debounce window before buffered transcripts are sent to the MarketingClaw agent. */
  debounceMs?: number;
...
export type DiscordVoiceAgentSessionConfig = {
  /** Which MarketingClaw conversation should receive voice turns. Default: "voice". */
  mode?: "voice" | "target";
...
export type DiscordVoiceConfig = {
  ...
  /** Route voice turns through an existing MarketingClaw Discord conversation. */
