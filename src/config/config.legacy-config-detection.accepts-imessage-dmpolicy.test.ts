...
function expectMarketingClawSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = MarketingClawSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectMarketingClawSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = MarketingClawSchema.safeParse(config);
