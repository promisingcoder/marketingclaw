      ...
      plugins: [
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/brave/marketingclaw.plugin.json",
        ...
        ...mockWebSearchProviders
          ...
          .map((provider) => ({
            ...
            source: "test",
            manifestPath: `/tmp/plugins/${provider.pluginId}/marketingclaw.plugin.json`,
          ...
          })),
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/acme-search/marketingclaw.plugin.json",
