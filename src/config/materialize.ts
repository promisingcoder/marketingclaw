...
import type { MarketingClawConfig, ResolvedSourceConfig, RuntimeConfig } from "./types.js";
...
export function asResolvedSourceConfig(config: MarketingClawConfig): ResolvedSourceConfig {
  return config as ResolvedSourceConfig;
}

export function asRuntimeConfig(config: MarketingClawConfig): RuntimeConfig {
