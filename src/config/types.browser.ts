...
export type BrowserProfileConfig = {
  ...
  mcpArgs?: string[];
  /**
   * Profile driver (default: marketingclaw). "extension" attaches to the user's
   * signed-in browser through the MarketingClaw Chrome extension relay.
   */
  driver?: "marketingclaw" | "clawd" | "existing-session" | "extension";
...
export type BrowserConfig = {
  ...
  /** Accent color for the marketingclaw browser profile (hex). Default: #FF4500 */
  color?: string;
