...
export type WideAreaDiscoveryConfig = {
  ...
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "marketingclaw.internal"). */
  domain?: string;
};
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/marketingclaw"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__marketingclaw__/canvas or /__marketingclaw__/a2ui content.
   */
...
export type GatewayTailscaleConfig = {
  ...
  resetOnExit?: boolean;
  /** Optional Tailscale Service name, such as `svc:marketingclaw`, for Serve mode. */
  serviceName?: string;
  /**
   ...
   * startup. Lets operators manage Funnel exposure outside MarketingClaw without
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/promisingcoder/marketingclaw/issues/65485
   */
...
export type GatewayConfig = {
   ...
   * Env var MARKETINGCLAW_HANDSHAKE_TIMEOUT_MS takes precedence. Default: 15000.
   */
