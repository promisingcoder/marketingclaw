...
import {
  ...
  isSameMarketingClawStableFamily,
  parseMarketingClawVersion,
  shouldWarnOnTouchedVersion,
} from "./version.js";

describe("parseMarketingClawVersion", () => {
  it("parses stable, correction, and beta forms", () => {
    expect(parseMarketingClawVersion("2026.3.23")).toEqual({
      major: 2026,
      minor: 3,
      patch: 23,
      revision: null,
    ...
    expect(parseMarketingClawVersion("2026.3.23-1")).toEqual({
      major: 2026,
      minor: 3,
      patch: 23,
      revision: 1,
    ...
    expect(parseMarketingClawVersion("2026.3.23-beta.1")).toEqual({
      major: 2026,
      minor: 3,
      patch: 23,
      revision: null,
    ...
    expect(parseMarketingClawVersion("v2026.3.23.beta.2")).toEqual({
      major: 2026,
      minor: 3,
      patch: 23,
      revision: null,
  ...
  it("rejects invalid versions", () => {
    expect(parseMarketingClawVersion("2026.3")).toBeNull();
    expect(parseMarketingClawVersion("latest")).toBeNull();
  });
});

describe("compareMarketingClawVersions", () => {
  it("treats correction publishes as newer than the base stable release", () => {
    expect(compareMarketingClawVersions("2026.3.23", "2026.3.23-1")).toBe(-1);
    expect(compareMarketingClawVersions("2026.3.23-1", "2026.3.23")).toBe(1);
    expect(compareMarketingClawVersions("2026.3.23-2", "2026.3.23-1")).toBe(1);
  });

  it("treats stable as newer than beta and compares beta identifiers", () => {
    expect(compareMarketingClawVersions("2026.3.23", "2026.3.23-beta.1")).toBe(1);
    expect(compareMarketingClawVersions("2026.3.23-beta.2", "2026.3.23-beta.1")).toBe(1);
    expect(compareMarketingClawVersions("2026.3.23.beta.1", "2026.3.23-beta.2")).toBe(-1);
  });
});

describe("isSameMarketingClawStableFamily", () => {
  it("treats same-base stable and correction versions as one family", () => {
    expect(isSameMarketingClawStableFamily("2026.3.23", "2026.3.23-1")).toBe(true);
    expect(isSameMarketingClawStableFamily("2026.3.23-1", "2026.3.23-2")).toBe(true);
    expect(isSameMarketingClawStableFamily("2026.3.23", "2026.3.24")).toBe(false);
    expect(isSameMarketingClawStableFamily("2026.3.23-beta.1", "2026.3.23")).toBe(false);
  });
});
