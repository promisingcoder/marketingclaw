...
describe("multi-agent agentDir validation", () => {
  it("rejects shared agents.list agentDir", () => {
    const shared = path.join(tmpdir(), "marketingclaw-shared-agentdir");
    ...
    await withTempHomeConfig(
      {
        agents: {
          list: [
            { id: "a", agentDir: "~/.marketingclaw/agents/shared/agent" },
            { id: "b", agentDir: "~/.marketingclaw/agents/shared/agent" },
          ],
        },
