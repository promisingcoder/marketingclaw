...
${formatHelpExamples([
  ['marketingclaw message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'marketingclaw message send --target +15555550123 --message "Hi" --media photo.jpg',
    "Send a message with media.",
  ],
  [
    'marketingclaw message poll --channel discord --target channel:123 --poll-question "Snack?" --poll-option Pizza --poll-option Sushi',
    "Create a Discord poll.",
  ],
  [
    'marketingclaw message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.marketingclaw.ai/cli/message")}`,
    )
    .action(() => {
