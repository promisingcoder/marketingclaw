    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["marketingclaw", "Start Crestodian."],
          ["marketingclaw crestodian", "Start Crestodian explicitly."],
          ['marketingclaw crestodian -m "status"', "Run one status request."],
          [
            'marketingclaw crestodian -m "set default model openai/gpt-5.2" --yes',
