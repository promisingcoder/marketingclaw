...
export function registerSkillsCli(program: Command) {
  const skills = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/skills", "docs.marketingclaw.ai/cli/skills")}\n`,
    );
  ...
  skills
    ...
    .addHelpText("after", "\nExamples:\n  marketingclaw skills install @owner/weather\n")
    .action(
      async (
        slug: string,
        opts: {
  ...
  skills
    ...
    .option("--agent <id>", "Target agent workspace (defaults to cwd-inferred, then default agent)")
    .addHelpText("after", "\nExamples:\n  marketingclaw skills verify @owner/weather\n")
    .action(
      async (
        slug: string,
