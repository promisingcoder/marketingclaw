    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["marketingclaw directory self --channel slack", "Show the connected account identity."],
          [
            'marketingclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          [
            "marketingclaw directory groups list --channel discord",
            "List available groups/channels.",
          ],
          [
            "marketingclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.marketingclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
