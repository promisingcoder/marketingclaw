...
function expectLoadMarketingClawPluginsCall(
  callIndex: number,
  expected: {
    config?: unknown;
  ...
  const params = mocks.loadMarketingClawPlugins.mock.calls[callIndex]?.[0] as
    | {
        config?: unknown;
        activationSourceConfig?: unknown;
        autoEnabledReasons?: unknown;
...
const mocks = vi.hoisted(() => ({
  loadMarketingClawPlugins: vi.fn<typeof import("../plugins/loader.js").loadMarketingClawPlugins>(),
...
vi.mock("../plugins/loader.js", () => ({
  loadMarketingClawPlugins: (...args: Parameters<typeof mocks.loadMarketingClawPlugins>) =>
    mocks.loadMarketingClawPlugins(...args),
  resolveCompatibleRuntimePluginRegistry: (
...
describe("ensurePluginRegistryLoaded", () => {
  ...
  it("uses the resolved runtime load context for configured channel scope", () => {
    ...
    expectLoadMarketingClawPluginsCall(0, {
      config: autoEnabledConfig,
  ...
  it("reloads when escalating from configured-channels to channels", () => {
    ...
    expectLoadMarketingClawPluginsCall(1, {
