...
export const QA_PARENT_PID_ENV = "MARKETINGCLAW_QA_PARENT_PID";
export const QA_TEMP_ROOT_ENV = "MARKETINGCLAW_QA_TEMP_ROOT";
export const QA_STAGED_RUNTIME_ROOT_ENV = "MARKETINGCLAW_QA_STAGED_RUNTIME_ROOT";

const DEFAULT_QA_PARENT_WATCHDOG_INTERVAL_MS = 1000;
const QA_TEMP_ROOT_PREFIX = "marketingclaw-qa-suite-";
