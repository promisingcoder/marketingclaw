    ...
    info: {
      ...
      hostRequirements: {
        "agent-run": {
          ...
          unsupportedMessage:
            "Use the native Codex or MarketingClaw embedded runtime, or switch contextEngine to legacy.",
        },
      },
    },
    async ingest() {
...
describe("context engine host compatibility", () => {
  ...
  it("allows native Codex and MarketingClaw embedded hosts to satisfy pre-prompt assembly", () => {
