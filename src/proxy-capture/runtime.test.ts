...
const settings: DebugProxySettings = {
  enabled: true,
  required: false,
  dbPath: "/tmp/marketingclaw-proxy-runtime-test.sqlite",
  blobDir: "/tmp/marketingclaw-proxy-runtime-test-blobs",
  certDir: "/tmp/marketingclaw-proxy-runtime-test-certs",
