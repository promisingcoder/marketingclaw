...
const MANAGED_SERVICE_ENV_KEYS_VAR = "MARKETINGCLAW_SERVICE_MANAGED_ENV_KEYS";

// Tracks which service environment keys MarketingClaw owns across reinstall/start flows.
