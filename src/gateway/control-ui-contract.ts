...
export const CONTROL_UI_BASE_PATH_ATTRIBUTE = "data-marketingclaw-control-ui-base-path";

/** Marks whether the served document CSP permits the terminal WASM runtime. */
export const CONTROL_UI_TERMINAL_ENABLED_ATTRIBUTE = "data-marketingclaw-terminal-enabled";
