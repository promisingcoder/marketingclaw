...
describe("resolvePinnedClientMetadata", () => {
  ...
  it.each([
    ["marketingclaw-ios", "iOS 26.5.0", "iOS 26.4.2", "iPhone"],
    ["marketingclaw-ios", "iPadOS 26.5.0", "iPadOS 26.4.2", "iPad"],
    ["marketingclaw-ios", "iPadOS 26.5.0", "iOS 26.4.2", "iPad"],
    ["marketingclaw-android", "Android 16", "Android 15", "Android"],
  ])(
