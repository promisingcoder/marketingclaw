...
// Removes MarketingClaw-only envelopes before messages are shown in UI/RPC results.
...
/** Strips MarketingClaw envelope metadata from one display message without mutating it. */
