...
function resolveDefaultStoreAgentId(cfg: MarketingClawConfig): string {
...
export function resolveSessionStoreAgentId(cfg: MarketingClawConfig, canonicalKey: string): string {
