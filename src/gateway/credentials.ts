  ...
  constructor(path: string) {
    super(
      [
        ...
        "Fix: set MARKETINGCLAW_GATEWAY_TOKEN/MARKETINGCLAW_GATEWAY_PASSWORD, pass explicit --token/--password,",
...
export function resolveGatewayCredentialsFromConfig(params: {
  ...
  const localTokenPrecedence =
    ...
    (env.MARKETINGCLAW_SERVICE_KIND === "gateway" ? "config-first" : "env-first");
