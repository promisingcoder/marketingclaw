...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __marketingclawDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore["__marketingclawDiagnosticStabilityState"] ??= createState();
  return globalStore["__marketingclawDiagnosticStabilityState"];
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore["__marketingclawDiagnosticStabilityState"] = next;
}
