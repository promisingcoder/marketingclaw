...
```bash
fork=$(gh api /repos/marketingclaw/marketingclaw/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/marketingclaw/marketingclaw/security-advisories/<GHSA> \
