...
- Applying repository-specific documentation overlays, including MarketingClaw page-type, docs IA, preservation, and validation rules when present.
...
6. For MarketingClaw docs work, read `references/marketingclaw.md` before the build/review playbook.
