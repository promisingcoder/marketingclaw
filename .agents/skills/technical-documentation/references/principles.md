...
When the target repo or request is MarketingClaw-specific, layer `references/marketingclaw.md` on top of these general rules. Otherwise ignore that repo-specific overlay.
