...
description: "Triage MarketingClaw security advisories, drafts, and GHSA reports with shipped-tag and trust-model proof."
---

# Security Triage

Use when reviewing MarketingClaw security advisories, drafts, or GHSA reports.
