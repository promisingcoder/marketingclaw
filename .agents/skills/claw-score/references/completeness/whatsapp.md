...
- Channel Setup and Operations: Official @marketingclaw/whatsapp plugin metadata, marketingclaw plugin install whatsapp, Channel config schema, Baileys socket lifecycle, Operator troubleshooting, Baileys socket lifecycle, Operator troubleshooting for reconnect loops
