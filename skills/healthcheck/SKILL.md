---
name: healthcheck
description: "Audit/harden MarketingClaw hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---
...
- Add scheduled `marketingclaw security audit --deep`.
