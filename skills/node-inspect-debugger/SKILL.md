...
metadata: { "marketingclaw": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- MarketingClaw CLI path: `node --inspect-brk marketingclaw.mjs ...`
- MarketingClaw test path: `MARKETINGCLAW_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
