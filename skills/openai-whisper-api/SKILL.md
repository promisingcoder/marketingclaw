...
Set `OPENAI_API_KEY`, or configure it in the active MarketingClaw config file (`$MARKETINGCLAW_CONFIG_PATH`, default `~/.marketingclaw/marketingclaw.json`). Optionally set `OPENAI_BASE_URL`:
