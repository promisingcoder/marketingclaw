...
export type MarketingClawVitestPool = "forks" | "threads";
...
export function resolveLocalVitestMaxWorkers(
  ...
  pool: MarketingClawVitestPool = resolveDefaultVitestPool(env),
): number {
...
function hasWorkerOverride(env: Record<string, string | undefined>): boolean {
  return Boolean((env.MARKETINGCLAW_VITEST_MAX_WORKERS ?? env.MARKETINGCLAW_TEST_WORKERS)?.trim());
}
...
const dependencyModuleDirectories = ["/node_modules/", "/marketingclaw-pnpm-node-modules/"];
const dependencyExternalPatterns = [
  /\/marketingclaw-pnpm-node-modules\/(?!.*\/?vite\w*\/dist\/client\/env\.mjs$).*\.(?:cjs\.js|mjs)$/u,
];
...
export const sharedVitestConfig = {
  ...
  resolve: {
    alias: [
      ...
      {
        find: "@marketingclaw/model-catalog-core/model-catalog-refs",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@marketingclaw/model-catalog-core/model-catalog-normalize",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@marketingclaw/model-catalog-core/model-catalog-types",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@marketingclaw/model-catalog-core/provider-id",
        replacement: path.join(repoRoot, "packages", "model-catalog-core", "src", "provider-id.ts"),
      },
      {
        find: "@marketingclaw/model-catalog-core/provider-model-id-normalization",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@marketingclaw/model-catalog-core/provider-model-id-normalize",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@marketingclaw/normalization-core/error-coercion",
        replacement: path.join(
          repoRoot,
          "packages",
          "normalization-core",
      ...
      {
        find: "@marketingclaw/normalization-core/number-coercion",
        replacement: path.join(
          repoRoot,
          "packages",
          "normalization-core",
      ...
      {
        find: "@marketingclaw/normalization-core/record-coerce",
        replacement: path.join(
          repoRoot,
          "packages",
          "normalization-core",
      ...
      {
        find: "@marketingclaw/normalization-core/string-coerce",
        replacement: path.join(
          repoRoot,
          "packages",
          "normalization-core",
      ...
      {
        find: "@marketingclaw/normalization-core/string-normalization",
        replacement: path.join(
          repoRoot,
          "packages",
          "normalization-core",
      ...
      {
        find: "@marketingclaw/normalization-core/utf16-slice",
        replacement: path.join(repoRoot, "packages", "normalization-core", "src", "utf16-slice.ts"),
      },
      {
        find: /^@marketingclaw\/normalization-core$/u,
      ...
      ...sourcePluginSdkSubpaths.map((subpath) => ({
        find: `marketingclaw/plugin-sdk/${subpath}`,
