...
function resolveQianfanPreset(cfg: MarketingClawConfig): {
  api: ModelApi;
  baseUrl: string;
...
const qianfanPresetAppliers = createDefaultModelsPresetAppliers({
  ...
  resolveParams: (cfg: MarketingClawConfig) => {
...
export function applyQianfanProviderConfig(cfg: MarketingClawConfig): MarketingClawConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: MarketingClawConfig): MarketingClawConfig {
