# @marketingclaw/zalouser

MarketingClaw extension for Zalo Personal Account messaging via native `zca-js` integration.
...
```bash
marketingclaw channels login --channel zalouser
marketingclaw channels login --channel zalouser --account work
...
- Login not persisted: `marketingclaw channels logout --channel zalouser && marketingclaw channels login --channel zalouser`
- Probe status: `marketingclaw channels status --probe`
