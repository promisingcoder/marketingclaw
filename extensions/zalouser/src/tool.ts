...
import { stringEnum } from "marketingclaw/plugin-sdk/channel-actions";
import type { AnyAgentTool, MarketingClawPluginToolContext } from "marketingclaw/plugin-sdk/core";
import { formatErrorMessage } from "marketingclaw/plugin-sdk/error-runtime";
import { jsonResult as json, type AgentToolResult } from "marketingclaw/plugin-sdk/tool-results";
...
type ZalouserToolContext = Pick<MarketingClawPluginToolContext, "deliveryContext">;
