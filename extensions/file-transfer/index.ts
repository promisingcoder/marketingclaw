// File Transfer plugin entrypoint registers its MarketingClaw integration.
import {
  definePluginEntry,
  type AnyAgentTool,
  type MarketingClawPluginNodeHostCommand,
...
const fileTransferNodeHostCommands: MarketingClawPluginNodeHostCommand[] = [
  {
    command: "file.fetch",
    cap: "file",
    dangerous: true,
