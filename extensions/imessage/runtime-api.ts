...
import type { MarketingClawConfig as RuntimeApiMarketingClawConfig } from "marketingclaw/plugin-sdk/config-contracts";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiMarketingClawConfig["channels"]>["imessage"]>,
