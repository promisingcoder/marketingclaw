...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "marketingclaw/plugin-sdk/config-contracts";
...
export function listWhatsAppAuthDirs(cfg: MarketingClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: MarketingClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: MarketingClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: MarketingClawConfig): ResolvedWhatsAppAccount[] {
