...
import type { ManagedProcess, MarketingClawExecServer, ProcessChunk } from "./types.js";
...
async function runProcess(
  ...
  if (!command) {
    throw new Error("MarketingClaw sandbox exec spec did not provide a command.");
  }
