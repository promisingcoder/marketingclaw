...
import { clearRuntimeAuthProfileStoreSnapshots } from "marketingclaw/plugin-sdk/agent-runtime";
...
describe("codex conversation controls", () => {
  beforeEach(async () => {
    resetCodexTestBindingStore();
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "marketingclaw-codex-control-"));
