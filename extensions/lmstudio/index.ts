// Lmstudio plugin entrypoint registers its MarketingClaw integration.
import {
  definePluginEntry,
...
function resolveLmstudioAugmentedCatalogEntries(config: MarketingClawConfig | undefined) {
  if (!config) {
    return [];
  }
