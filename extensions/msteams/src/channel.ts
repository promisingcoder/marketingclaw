...
import { createTopLevelChannelConfigAdapter } from "marketingclaw/plugin-sdk/channel-config-helpers";
import type {
...
const resolveMSTeamsChannelConfig = (cfg: MarketingClawConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: MarketingClawConfig }>(
