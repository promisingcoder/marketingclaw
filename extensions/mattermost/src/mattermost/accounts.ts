...
import { resolveMergedAccountConfig } from "marketingclaw/plugin-sdk/account-resolution";
import {
...
export function listMattermostAccountIds(cfg: MarketingClawConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: MarketingClawConfig): string {
