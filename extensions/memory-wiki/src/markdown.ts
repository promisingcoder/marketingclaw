...
export const WIKI_RELATED_START_MARKER = "<!-- marketingclaw:wiki:related:start -->";
export const WIKI_RELATED_END_MARKER = "<!-- marketingclaw:wiki:related:end -->";
export const WIKI_RAW_SOURCE_MARKER = "<!-- marketingclaw:wiki:raw-source -->";
...
const HUMAN_START_MARKER = "<!-- marketingclaw:human:start -->";
const HUMAN_END_MARKER = "<!-- marketingclaw:human:end -->";
