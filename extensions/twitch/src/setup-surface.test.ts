...
const originalEnvToken = process.env.MARKETINGCLAW_TWITCH_ACCESS_TOKEN;
...
describe("setup surface helpers", () => {
  ...
  afterEach(() => {
    if (originalEnvToken === undefined) {
      ...
      process.env.MARKETINGCLAW_TWITCH_ACCESS_TOKEN = originalEnvToken;
    }
  ...
  describe("defaultAccount setup resolution", () => {
    ...
    it("reports env-token default account setup as configured", async () => {
      process.env.MARKETINGCLAW_TWITCH_ACCESS_TOKEN = "oauth:fromenv";
