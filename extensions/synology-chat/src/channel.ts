/**
 * Synology Chat Channel Plugin for MarketingClaw.
 *
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "marketingclaw pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: MarketingClawConfig; id: string }) => Promise<void>;
  };
  security: {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to MarketingClaw",
        order: 90,
      },
      capabilities: {
    ...
    pairing: {
      text: {
        ...
        message: "MarketingClaw: your access has been approved.",
