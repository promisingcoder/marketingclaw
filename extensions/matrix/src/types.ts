...
export type MatrixStreamingConfig = {
  ...
  progress?: import("marketingclaw/plugin-sdk/channel-outbound").ChannelStreamingProgressConfig;
  preview?: {
...
export type CoreConfig = {
  ...
  session?: {
    store?: string;
    dmScope?: NonNullable<MarketingClawConfig["session"]>["dmScope"];
  };
  messages?: {
    ackReaction?: string;
    ackReactionScope?: "group-mentions" | "group-all" | "direct" | "all" | "none" | "off";
  };
  secrets?: MarketingClawConfig["secrets"];
  [key: string]: unknown;
};
