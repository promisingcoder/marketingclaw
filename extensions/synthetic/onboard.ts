...
export function applySyntheticProviderConfig(cfg: MarketingClawConfig): MarketingClawConfig {
  return syntheticPresetAppliers.applyProviderConfig(cfg);
}

export function applySyntheticConfig(cfg: MarketingClawConfig): MarketingClawConfig {
