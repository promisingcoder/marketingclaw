...
vi.mock("marketingclaw/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<
    typeof import("marketingclaw/plugin-sdk/media-understanding")
  >("marketingclaw/plugin-sdk/media-understanding");
  return {
    ...actual,
...
afterAll(() => {
  vi.doUnmock("marketingclaw/plugin-sdk/media-understanding");
  vi.resetModules();
});
