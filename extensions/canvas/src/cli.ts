...
import { runCommandWithRuntime, theme } from "marketingclaw/plugin-sdk/cli-runtime";
...
import { defaultRuntime } from "marketingclaw/plugin-sdk/runtime";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalString,
} from "marketingclaw/plugin-sdk/string-coerce-runtime";
import { shortenHomePath } from "marketingclaw/plugin-sdk/text-utility-runtime";
...
/** Creates the default Canvas CLI dependency bundle backed by the MarketingClaw gateway CLI. */
    ...
    a2ui
      ...
      .action(async (opts: CanvasNodesRpcOpts) => {
        await deps.runNodesCommand("canvas a2ui push", async () => {
          ...
          if (version === "v0.9") {
            throw new Error(
              "Detected A2UI v0.9 JSONL (createSurface). MarketingClaw currently supports v0.8 only.",
            );
          }
