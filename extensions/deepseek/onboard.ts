...
function applyDeepSeekProviderConfig(cfg: MarketingClawConfig): MarketingClawConfig {
...
export function applyDeepSeekConfig(cfg: MarketingClawConfig): MarketingClawConfig {
