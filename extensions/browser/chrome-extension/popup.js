...
const STATE_LABEL = {
  on: "Connected to MarketingClaw",
  connecting: "Connecting…",
  error: "Relay unreachable — is the MarketingClaw gateway running?",
  off: "Not connected",
};
...
async function refresh() {
  ...
  shareButton.textContent = shared ? "Stop sharing this tab" : "Share this tab with MarketingClaw";
