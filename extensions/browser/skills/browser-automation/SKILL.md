...
description: Use when controlling web pages with the MarketingClaw browser tool, especially multi-step flows, login checks, tab management, or recovery from stale refs/timeouts.
