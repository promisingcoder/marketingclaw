...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload from MarketingClaw temp uploads or managed inbound media (e.g. /tmp/marketingclaw/uploads/file.pdf or media://inbound/<id>)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within marketingclaw temp downloads dir (default: /tmp/marketingclaw/downloads/...; fallback: os.tmpdir()/marketingclaw/downloads/...)",
    )
    .option("--target-id <id>", BROWSER_TAB_REFERENCE_HELP)
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within marketingclaw temp downloads dir (e.g. report.pdf or /tmp/marketingclaw/downloads/report.pdf)",
    )
    .option("--target-id <id>", BROWSER_TAB_REFERENCE_HELP)
    .option(
      "--timeout-ms <ms>",
