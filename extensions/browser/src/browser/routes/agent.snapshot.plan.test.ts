...
function profile(driver: "existing-session" | "marketingclaw"): ResolvedBrowserProfile {
  return {
    name: driver === "existing-session" ? "user" : "marketingclaw",
    driver,
