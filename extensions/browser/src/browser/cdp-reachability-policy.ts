...
export function resolveCdpReachabilityPolicy(
  ...
  // The browser SSRF policy protects page/network navigation, not MarketingClaw's
  ...
  if (!capabilities.isRemote && profile.cdpIsLoopback && profile.driver === "marketingclaw") {
    return undefined;
  }
