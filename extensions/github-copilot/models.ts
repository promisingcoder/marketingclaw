...
import { readProviderJsonArrayFieldResponse } from "marketingclaw/plugin-sdk/provider-http";
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in marketingclaw.json — no
