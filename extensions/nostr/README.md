...
Nostr DM channel plugin for MarketingClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to MarketingClaw. It enables your bot to:
...
# Configure marketingclaw to use local relay
