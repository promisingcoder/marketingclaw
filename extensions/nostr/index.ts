// Nostr plugin entrypoint registers its MarketingClaw integration.
import {
  defineBundledChannelEntry,
  loadBundledEntryExportSync,
} from "marketingclaw/plugin-sdk/channel-entry-contract";
import type { MarketingClawConfig, PluginRuntime, ResolvedNostrAccount } from "./api.js";
  ...
  registerFull(api) {
    const httpHandler = createNostrProfileHttpHandler()({
      getConfigProfile: (accountId: string) => {
        ...
        const cfg = runtime.config.current() as MarketingClawConfig;
