...
function resolveConfiguredDefaultNostrAccountId(cfg: MarketingClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: MarketingClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: MarketingClawConfig): string {
