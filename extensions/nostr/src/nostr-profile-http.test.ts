...
vi.mock("./nostr-profile-http-runtime.js", async () => {
  const webhookIngress = await import("marketingclaw/plugin-sdk/webhook-ingress");
  const requestGuards = await import("marketingclaw/plugin-sdk/webhook-request-guards");
  return {
