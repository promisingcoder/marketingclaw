...
describe("zai model definitions", () => {
  ...
  it("uses current MarketingClaw metadata for the new GLM-5.1 model", () => {
    expectZaiModelFields({
      id: "glm-5.1",
      reasoning: true,
      input: ["text"],
  ...
  it("uses current MarketingClaw metadata for the new GLM-5V Turbo model", () => {
    expectZaiModelFields({
      id: "glm-5v-turbo",
      reasoning: true,
      input: ["text", "image"],
  ...
  it("uses current MarketingClaw metadata for the GLM-5 model", () => {
    expectZaiModelFields({
      id: "glm-5",
      reasoning: true,
      input: ["text"],
  ...
  it("publishes newer GLM 4.5/4.6 family metadata from MarketingClaw", () => {
    expectZaiModelFields({
      id: "glm-4.6v",
      input: ["text", "image"],
  ...
  it("keeps the remaining GLM 4.7/5 pricing and token limits aligned with MarketingClaw", () => {
    expectZaiModelFields({
      id: "glm-4.7-flash",
