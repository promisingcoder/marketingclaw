...
describe("discord doctor", () => {
  ...
  it("removes unsupported Discord realtime wake names", () => {
    ...
    expect(result.changes).toEqual([
      ...
      "Removed empty channels.discord.accounts.empty.voice.realtime.wakeNames; unset wake names use the default agent/MarketingClaw fallback.",
  ...
  it("repairs safe numeric ids into strings and warns for unsafe lists", () => {
    ...
    const result = maybeRepairDiscordNumericIds(cfg, "marketingclaw doctor --fix");
