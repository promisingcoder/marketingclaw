...
import type { InboundEventKind } from "marketingclaw/plugin-sdk/channel-inbound";
import type { MarketingClawConfig, ReplyToMode } from "marketingclaw/plugin-sdk/config-contracts";
import type { SessionBindingRecord } from "marketingclaw/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "marketingclaw/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "marketingclaw/plugin-sdk/routing";
...
type LoadedConfig = MarketingClawConfig;
export type RuntimeEnv = import("marketingclaw/plugin-sdk/runtime-env").RuntimeEnv;
