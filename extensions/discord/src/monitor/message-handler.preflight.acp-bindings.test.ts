...
import * as conversationBindingRuntime from "marketingclaw/plugin-sdk/conversation-binding-runtime";
...
import { testing as sessionBindingTesting } from "marketingclaw/plugin-sdk/conversation-runtime";
  ...
  return {
    ...createDiscordPreflightArgs({
      ...
      discordConfig: {
        ...
        import("marketingclaw/plugin-sdk/config-contracts").MarketingClawConfig["channels"]
      >["discord"],
