...
vi.mock("marketingclaw/plugin-sdk/reply-dispatch-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("marketingclaw/plugin-sdk/reply-dispatch-runtime")
...
vi.mock("marketingclaw/plugin-sdk/command-status-runtime", () => ({
...
function createConfig(params?: { requireMention?: boolean }): MarketingClawConfig {
  return {
    commands: {
...
describe("discord native /status", () => {
  ...
  beforeEach(() => {
    ...
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("marketingclaw/plugin-sdk/reply-dispatch-runtime").dispatchReplyWithDispatcher,
    );
    discordNativeCommandTesting.setMatchPluginCommand(
      (() => null) as typeof import("marketingclaw/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
  ...
  it("prioritizes direct status replies over matching plugin commands", async () => {
    ...
    discordNativeCommandTesting.setMatchPluginCommand((() => ({
      ...
      args: undefined,
    })) as typeof import("marketingclaw/plugin-sdk/plugin-runtime").matchPluginCommand);
    discordNativeCommandTesting.setExecutePluginCommand(
      executePluginCommand as typeof import("marketingclaw/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    const cfg = createConfig();
    const command = await createStatusCommand(cfg);
    const interaction = createInteraction();
