...
let runtimeEnvModule: typeof import("marketingclaw/plugin-sdk/runtime-env");
...
describe("monitorDiscordProvider", () => {
  ...
  beforeAll(async () => {
    vi.doMock("marketingclaw/plugin-sdk/plugin-runtime", async () => {
      const actual = await vi.importActual<
        typeof import("marketingclaw/plugin-sdk/plugin-runtime")
    ...
    runtimeEnvModule = await import("marketingclaw/plugin-sdk/runtime-env");
  ...
  it("passes MarketingClaw event queue defaults to the Discord client", async () => {
    await monitorDiscordProvider({
      config: baseConfig(),
      runtime: baseRuntime(),
    });
