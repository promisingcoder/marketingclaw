...
const DISCORD_GATEWAY_READY_TIMEOUT_ENV = "MARKETINGCLAW_DISCORD_READY_TIMEOUT_MS";
const DISCORD_GATEWAY_RUNTIME_READY_TIMEOUT_ENV = "MARKETINGCLAW_DISCORD_RUNTIME_READY_TIMEOUT_MS";
