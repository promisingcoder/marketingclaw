...
import { loadWebMediaRaw } from "marketingclaw/plugin-sdk/web-media";
import { afterAll, afterEach, beforeAll, beforeEach, describe, expect, it, vi } from "vitest";
import { RateLimitError } from "./internal/discord.js";
import { makeDiscordRest } from "./send.test-harness.js";

vi.mock("marketingclaw/plugin-sdk/web-media", async () => {
...
afterAll(() => {
  vi.doUnmock("marketingclaw/plugin-sdk/web-media");
});
...
describe("uploadStickerDiscord", () => {
  ...
  it("uploads sticker assets", async () => {
    ...
    await uploadStickerDiscord(
      {
        guildId: "g1",
        name: "marketingclaw_wave",
        description: "MarketingClaw waving",
        tags: "👋",
    ...
    expect(stickerBody.name).toBe("marketingclaw_wave");
    expect(stickerBody.description).toBe("MarketingClaw waving");
