...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("marketingclaw.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("marketingclaw.discord.modalEntries");
