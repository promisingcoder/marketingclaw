...
describe("qa tool coverage report", () => {
  ...
  it("keeps searchable MarketingClaw dynamic tool rows report-only by default", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-searchable-web-search", "web-search", {
          ...
          toolCoverage: {
            ...
            capabilityLayer: "marketingclaw-dynamic-searchable",
          },
        }),
      ],
      summary: {
  ...
  it("passes required MarketingClaw dynamic tool coverage when both runtimes exercise the tool", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          ...
          toolCoverage: {
            bucket: "marketingclaw-dynamic-integration",
            expectedLayer: "marketingclaw-dynamic",
            capabilityLayer: "marketingclaw-dynamic-direct",
            required: true,
          },
        }),
      ],
  ...
  it("passes required MarketingClaw dynamic tool coverage when Codex reports a soft tool error", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
  ...
  it("fails required MarketingClaw dynamic tool coverage when a runtime skips the tool", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
  ...
  it("fails required MarketingClaw dynamic tool coverage when the fixture failure mode is preserved", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
