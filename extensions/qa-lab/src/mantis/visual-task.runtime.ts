...
import { pathExists, writeExternalFileWithinRoot } from "marketingclaw/plugin-sdk/security-runtime";
...
function browserLaunchScript() {
  return [
    ...
    'profile="${TMPDIR:-/tmp}/marketingclaw-mantis-visual-chrome-profile"',
    'mkdir -p "$profile"',
