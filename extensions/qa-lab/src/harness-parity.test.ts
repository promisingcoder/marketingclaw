...
const LEFT: HarnessVariant = { id: "left", label: "Left", runtime: "marketingclaw" };
const RIGHT: HarnessVariant = { id: "right", label: "Right", runtime: "marketingclaw" };
...
function classify(
  ...
  return buildHarnessParityResult({
    ...
    left: buildHarnessParityCell({
      variant: LEFT,
      cell: makeCell("marketingclaw", left),
      tokenUsageSource: "live-usage",
    }),
    right: buildHarnessParityCell({
      variant: RIGHT,
      cell: makeCell("marketingclaw", right),
      tokenUsageSource: "live-usage",
    }),
...
describe("harness parity", () => {
  ...
  it("labels mock token estimates separately from live usage", () => {
    const sourceCell = makeCell("marketingclaw", {
