...
describe("qa-lab web search provider", () => {
  ...
  it("returns deterministic normalized web_search results", async () => {
    ...
    const result = await tool.execute({
      query: "MarketingClaw runtime parity fixed query",
      count: 2,
    });
    ...
    expect(result).toMatchObject({
      ...
      results: [
        {
          url: "https://docs.marketingclaw.ai/qa-lab/search-fixture/1",
          siteName: "docs.marketingclaw.ai",
        },
        {
          url: "https://docs.marketingclaw.ai/qa-lab/search-fixture/2",
          siteName: "docs.marketingclaw.ai",
        },
      ],
    });
