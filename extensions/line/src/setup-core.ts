...
import type { ChannelSetupAdapter, MarketingClawConfig } from "marketingclaw/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "marketingclaw/plugin-sdk/setup";
...
export function isLineConfigured(cfg: MarketingClawConfig, accountId: string): boolean {
