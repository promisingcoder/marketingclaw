// Google Meet plugin entrypoint registers its MarketingClaw integration.
import {
...
const googleMeetConfigSchema = {
  ...
  uiHints: {
    ...
    defaultMode: {
      label: "Default Mode",
      help: "Agent uses realtime transcription plus regular MarketingClaw TTS. Bidi uses the realtime voice model directly. Transcribe observes only.",
    },
    "chrome.audioBackend": {
    ...
    "chrome.autoJoin": {
      ...
      help: "Best-effort guest-name fill and Join Now click through MarketingClaw browser automation.",
    },
    ...
    "realtime.transcriptionProvider": {
      ...
      help: "Agent mode uses this provider to transcribe meeting audio before regular MarketingClaw TTS answers.",
    },
    ...
    "realtime.model": {
      ...
      help: "Only used by mode=bidi. Agent mode answers with the configured MarketingClaw agent and regular TTS.",
      advanced: true,
    },
    ...
    "realtime.agentId": {
      ...
      help: 'MarketingClaw agent id used by marketingclaw_agent_consult. Defaults to "main".',
      advanced: true,
    },
    "realtime.toolPolicy": {
