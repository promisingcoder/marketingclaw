...
import { parseAccessGroupAllowFromEntry } from "marketingclaw/plugin-sdk/access-groups";
import {
  createChannelIngressResolver,
  defineStableChannelIngressIdentity,
} from "marketingclaw/plugin-sdk/channel-ingress-runtime";
import { resolveInboundMentionDecision } from "marketingclaw/plugin-sdk/channel-mention-gating";
  ...
  return {
    async resolveInboundAccess(input) {
      ...
      const resolved = await createChannelIngressResolver({
        ...
        cfg: input.cfg as MarketingClawConfig,
      }).message({
