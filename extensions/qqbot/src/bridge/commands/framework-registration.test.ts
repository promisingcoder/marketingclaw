...
function registerCommands(): MarketingClawPluginCommandDefinition[] {
  ensurePlatformAdapter();
  const commands: MarketingClawPluginCommandDefinition[] = [];
  const api = {
    logger: {},
    registerCommand: (command: MarketingClawPluginCommandDefinition) => {
...
function findCommand(
  commands: MarketingClawPluginCommandDefinition[],
  name: string,
): MarketingClawPluginCommandDefinition {
