...
vi.mock("marketingclaw/plugin-sdk/memory-core-host-engine-embeddings", async (importOriginal) => {
  const actual =
    await importOriginal<
      typeof import("marketingclaw/plugin-sdk/memory-core-host-engine-embeddings")
    >();
  return {
    ...actual,
