...
vi.mock("./client.js", () => {
  return {
    FEISHU_HTTP_TIMEOUT_ENV_VAR: "MARKETINGCLAW_FEISHU_HTTP_TIMEOUT_MS",
    FEISHU_HTTP_TIMEOUT_MAX_MS: 300_000,
    FEISHU_HTTP_TIMEOUT_MS: 30_000,
    FEISHU_USER_AGENT: "marketingclaw-feishu-test",
    ...
    getFeishuUserAgent: vi.fn(() => "marketingclaw-feishu-test"),
    pluginVersion: "test",
