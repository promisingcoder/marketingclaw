...
type BuildCommandTextFromArgs =
  typeof import("marketingclaw/plugin-sdk/command-auth-native").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("marketingclaw/plugin-sdk/command-auth-native").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("marketingclaw/plugin-sdk/command-auth-native").listNativeCommandSpecsForConfig;
type ParseCommandArgs =
  typeof import("marketingclaw/plugin-sdk/command-auth-native").parseCommandArgs;
