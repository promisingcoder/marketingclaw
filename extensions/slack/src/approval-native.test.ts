...
function buildConfig(
  overrides?: Partial<NonNullable<NonNullable<MarketingClawConfig["channels"]>["slack"]>>,
): MarketingClawConfig {
  return {
    channels: {
      slack: {
...
const STORE_PATH = path.join(os.tmpdir(), "marketingclaw-slack-approval-native-test.json");
