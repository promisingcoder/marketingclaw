...
import { parseFiniteNumber } from "marketingclaw/plugin-sdk/number-runtime";
...
function resolveDefaultDbPath(): string {
  const home = homedir();
  const preferred = join(home, ".marketingclaw", "memory", "lancedb");
  try {
...
export const memoryConfigSchema = {
  ...
  uiHints: {
    ...
    dbPath: {
      label: "Database Path",
      placeholder: "~/.marketingclaw/memory/lancedb",
      advanced: true,
