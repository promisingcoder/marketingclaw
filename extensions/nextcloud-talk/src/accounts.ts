...
import { tryReadSecretFileSync } from "marketingclaw/plugin-sdk/secret-file-runtime";
import {
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.MARKETINGCLAW_DEBUG_NEXTCLOUD_TALK_ACCOUNTS)) {
