...
import { resolveApprovalApprovers } from "marketingclaw/plugin-sdk/approval-auth-runtime";
import {
...
import { resolveApprovalRequestChannelAccountId } from "marketingclaw/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "marketingclaw/plugin-sdk/approval-runtime";
import type { MarketingClawConfig } from "marketingclaw/plugin-sdk/config-contracts";
import type { TelegramExecApprovalConfig } from "marketingclaw/plugin-sdk/config-contracts";
...
function resolveTelegramOwnerApprovers(cfg: MarketingClawConfig): Array<string | number> {
