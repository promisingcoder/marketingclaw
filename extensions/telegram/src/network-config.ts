...
import { isTruthyEnvValue, isWSL2Sync } from "marketingclaw/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "marketingclaw/plugin-sdk/string-coerce-runtime";

const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "MARKETINGCLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "MARKETINGCLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "MARKETINGCLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable MARKETINGCLAW_TELEGRAM_DNS_RESULT_ORDER
