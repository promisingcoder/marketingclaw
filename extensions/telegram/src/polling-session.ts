...
const TELEGRAM_GET_UPDATES_CONFLICT_HINT =
  " Another MarketingClaw gateway, script, or Telegram poller may be using this bot token; stop the duplicate poller or switch this account to webhook mode.";
...
const TELEGRAM_SPOOLED_HANDLER_TIMEOUT_ENV = "MARKETINGCLAW_TELEGRAM_SPOOLED_HANDLER_TIMEOUT_MS";
...
export class TelegramPollingSession {
  ...
  async runUntilAbort(): Promise<void> {
    ...
    try {
      ...
      // leak to api.telegram.org; see marketingclaw#68128.
