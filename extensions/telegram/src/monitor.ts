...
import { resolveAgentMaxConcurrent } from "marketingclaw/plugin-sdk/model-session-runtime";
...
function createTelegramRunnerOptions(cfg: MarketingClawConfig): RunOptions<unknown> {
  return {
    sink: {
