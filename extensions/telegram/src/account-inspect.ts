...
import { resolveAccountWithDefaultFallback } from "marketingclaw/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "marketingclaw/plugin-sdk/channel-core";
import type { MarketingClawConfig } from "marketingclaw/plugin-sdk/config-contracts";
import type { TelegramAccountConfig } from "marketingclaw/plugin-sdk/config-contracts";
import { resolveDefaultSecretProviderAlias } from "marketingclaw/plugin-sdk/provider-auth";
...
import { coerceSecretRef } from "marketingclaw/plugin-sdk/secret-input-runtime";
...
function inspectTokenValue(params: { cfg: MarketingClawConfig; value: unknown }): {
  token: string;
...
function hasConfiguredTelegramAccounts(cfg: MarketingClawConfig): boolean {
