...
vi.mock("marketingclaw/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("marketingclaw/plugin-sdk/hook-runtime")>(
    "marketingclaw/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
