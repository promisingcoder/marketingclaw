...
} from "marketingclaw/plugin-sdk/account-core";
import type {
  TelegramAccountConfig,
  TelegramActionConfig,
} from "marketingclaw/plugin-sdk/config-contracts";
import { formatSetExplicitDefaultInstruction } from "marketingclaw/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "marketingclaw/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.MARKETINGCLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: MarketingClawConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: MarketingClawConfig): string {
...
export function listEnabledTelegramAccounts(cfg: MarketingClawConfig): ResolvedTelegramAccount[] {
