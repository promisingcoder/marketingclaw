...
`marketingclaw/plugin-sdk/channel-message` and
`marketingclaw/plugin-sdk/channel-message-runtime` remain deprecated compatibility
subpaths for older plugins; both are thin aliases over the shared channel
message core. New channel plugins should use
`marketingclaw/plugin-sdk/channel-outbound` for message lifecycle, receipt,
