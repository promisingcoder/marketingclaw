---
summary: "Contributor guide for adding a new shared capability to the MarketingClaw plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for MarketingClaw core developers. If you are
...
Use this when MarketingClaw needs a new shared domain such as embeddings, image
