---
summary: "MarketingClaw Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
MarketingClaw Anthropic Vertex provider plugin for Claude models on Google Vertex AI.

## Distribution

- Package: `@marketingclaw/anthropic-vertex-provider`
...
`/think off` or the native `/think xhigh|max` levels. MarketingClaw publishes its
