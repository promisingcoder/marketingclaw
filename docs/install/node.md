...
```
  ...
  <Warning>
  Initialize your version manager in your shell startup file (`~/.zshrc` or `~/.bashrc`). If you skip this, `marketingclaw` may not be found in new terminal sessions because PATH won't include Node's bin directory.
  </Warning>
</Accordion>

## Troubleshooting

### `marketingclaw: command not found`
