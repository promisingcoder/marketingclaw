...
show_usage() {
    cat << EOF
clawlog - MarketingClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View MarketingClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    MarketingClaw logs flow through the macOS unified log (subsystem: ai.marketingclaw).
