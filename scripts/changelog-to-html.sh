...
if [[ -z "$version_content" ]]; then
  echo "<h2>MarketingClaw $VERSION</h2>"
  echo "<p>Latest MarketingClaw update.</p>"
  echo "<p><a href=\"https://github.com/promisingcoder/marketingclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
