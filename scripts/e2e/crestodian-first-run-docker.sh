...
IMAGE_NAME="$(docker_e2e_resolve_image "marketingclaw-crestodian-first-run-e2e" MARKETINGCLAW_CRESTODIAN_FIRST_RUN_E2E_IMAGE)"
CONTAINER_NAME="marketingclaw-crestodian-first-run-e2e-$$"
RUN_LOG="$(mktemp -t marketingclaw-crestodian-first-run-log.XXXXXX)"
...
MARKETINGCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-first-run empty)"
