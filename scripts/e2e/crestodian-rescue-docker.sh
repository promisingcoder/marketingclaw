...
IMAGE_NAME="$(docker_e2e_resolve_image "marketingclaw-crestodian-rescue-e2e" MARKETINGCLAW_CRESTODIAN_RESCUE_E2E_IMAGE)"
CONTAINER_NAME="marketingclaw-crestodian-rescue-e2e-$$"
RUN_LOG="$(mktemp -t marketingclaw-crestodian-rescue-log.XXXXXX)"
...
MARKETINGCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-rescue empty)"
...
docker_e2e_run_with_harness \
  ...
  -e "MARKETINGCLAW_GATEWAY_TOKEN=crestodian-rescue-token" \
  "$IMAGE_NAME" \
