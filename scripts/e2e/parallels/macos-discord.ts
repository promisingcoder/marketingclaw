// Macos Discord script supports MarketingClaw repository automation.
...
export class MacosDiscordSmoke {
  constructor(
    private input: {
      ...
      guest: MacosGuest;
      guestNode: string;
      guestMarketingClaw: string;
      guestMarketingClawEntry: string;
      runDir: string;
      vmName: string;
    },
  ) {}
...
${this.input.guestNode} ${this.input.guestMarketingClawEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestMarketingClawEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestMarketingClawEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestMarketingClawEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestMarketingClawEntry} doctor --fix --yes --non-interactive
...
JS
${this.input.guestNode} ${this.input.guestMarketingClawEntry} plugins enable discord
${this.input.guestNode} ${this.input.guestMarketingClawEntry} gateway restart
${this.input.guestNode} ${this.input.guestMarketingClawEntry} channels status --probe --json`);
  }
