// Windows Git script supports MarketingClaw repository automation.
...
try:
    req = urllib.request.Request(
        ...
        headers={
            "User-Agent": "marketingclaw-parallels-smoke",
...
$depsRoot = Join-Path $env:LOCALAPPDATA 'MarketingClaw\\deps'
