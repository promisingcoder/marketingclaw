...
IMAGE_NAME="$(docker_e2e_resolve_image "marketingclaw-commitments-safety-e2e" MARKETINGCLAW_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="marketingclaw-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t marketingclaw-commitments-safety-log.XXXXXX)"
