...
def resolve_sut(config, bot_config):
    ...
    token = (
        ...
        or os.environ.get("MARKETINGCLAW_QA_TELEGRAM_SUT_BOT_TOKEN")
...
def default_chat(config, bot_config):
    return (
        ...
        or os.environ.get("MARKETINGCLAW_QA_TELEGRAM_GROUP_ID")
...
class UserDriver:
    ...
    def td_params(self):
        ...
        params = {
            ...
            "device_model": "MarketingClaw Telegram User Driver",
