...
IMAGE_NAME="$(docker_e2e_resolve_image "marketingclaw-session-runtime-context-e2e" MARKETINGCLAW_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="marketingclaw-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t marketingclaw-session-runtime-context-log.XXXXXX)"
