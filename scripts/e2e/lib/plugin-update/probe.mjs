...
const pluginRecordSnapshot = () => {
  const config = readJson(marketingclawPath("marketingclaw.json"));
...
function marketingclawPath(...parts) {
  return path.join(home, ".marketingclaw", ...parts);
}
...
function seedInstallState() {
  writeJson(marketingclawPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.MARKETINGCLAW_CONFIG_PATH, { plugins: {} });
  writePluginInstallIndexForE2E({
    version: 1,
    warning: "DO NOT EDIT. This file is generated by MarketingClaw plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("MarketingClaw will continue without it")
  );
}
...
function assertCorruptPluginDetails(plugins, pluginId) {
  ...
  const expectedFragments = disabledAfterFailure
    ? [
        ...
        "MarketingClaw will continue without it",
