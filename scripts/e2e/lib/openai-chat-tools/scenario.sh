...
MODEL_REF="${MARKETINGCLAW_OPENAI_CHAT_TOOLS_MODEL:?missing MARKETINGCLAW_OPENAI_CHAT_TOOLS_MODEL}"
GATEWAY_LOG="/tmp/marketingclaw-openai-chat-tools-gateway.log"
CLIENT_LOG="/tmp/marketingclaw-openai-chat-tools-client.log"
gateway_pid=""
...
PORT="$PORT" MARKETINGCLAW_GATEWAY_TOKEN="$TOKEN" MODEL_REF="$MODEL_REF" \
