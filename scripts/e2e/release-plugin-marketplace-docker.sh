...
IMAGE_NAME="$(docker_e2e_resolve_image "marketingclaw-release-plugin-marketplace-e2e" MARKETINGCLAW_RELEASE_PLUGIN_MARKETPLACE_E2E_IMAGE)"
SKIP_BUILD="${MARKETINGCLAW_RELEASE_PLUGIN_MARKETPLACE_E2E_SKIP_BUILD:-0}"
run_log=""
cleanup() {
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-plugin-marketplace "${MARKETINGCLAW_CURRENT_PACKAGE_TGZ:-}")"
...
MARKETINGCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-plugin-marketplace empty)"
