...
IMAGE_NAME="$(docker_e2e_resolve_image "marketingclaw-crestodian-planner-e2e" MARKETINGCLAW_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="marketingclaw-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t marketingclaw-crestodian-planner-log.XXXXXX)"
...
MARKETINGCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"
