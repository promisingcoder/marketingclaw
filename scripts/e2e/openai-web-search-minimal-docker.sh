...
IMAGE_NAME="$(docker_e2e_resolve_image "marketingclaw-openai-web-search-minimal-e2e" MARKETINGCLAW_OPENAI_WEB_SEARCH_MINIMAL_E2E_IMAGE)"
SKIP_BUILD="${MARKETINGCLAW_OPENAI_WEB_SEARCH_MINIMAL_E2E_SKIP_BUILD:-0}"
...
MARKETINGCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 openai-web-search-minimal empty)"
...
docker_e2e_run_logged_with_harness openai-web-search-minimal \
  ...
  -e "OPENAI_API_KEY=sk-marketingclaw-web-search-minimal-e2e" \
