...
func docsI18nDocChunkMaxBytes() int {
	value := strings.TrimSpace(os.Getenv("MARKETINGCLAW_DOCS_I18N_DOC_CHUNK_MAX_BYTES"))
	if value == "" {
...
func docsI18nDocChunkPromptBudget() int {
	value := strings.TrimSpace(os.Getenv("MARKETINGCLAW_DOCS_I18N_DOC_CHUNK_PROMPT_BUDGET"))
	if value == "" {
