...
const (
	...
	envDocsI18nProvider      = "MARKETINGCLAW_DOCS_I18N_PROVIDER"
	envDocsI18nModel         = "MARKETINGCLAW_DOCS_I18N_MODEL"
...
func validateNoTranslationTranscriptArtifacts(source, translated string) error {
	...
	for _, token := range []string{"<marketingclaw_docs_i18n_input>", "</marketingclaw_docs_i18n_input>"} {
