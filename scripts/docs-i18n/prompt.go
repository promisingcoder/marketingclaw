...
- Keep product names in English: MarketingClaw, Raspberry Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the MarketingClaw Gateway, use “Gateway 网关”.
