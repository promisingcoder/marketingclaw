...
const LIVE_DOCKER_DEFAULT_HARNESS_DIR =
  ...
  process.env.MARKETINGCLAW_DOCKER_E2E_REPO_ROOT
    ? ".release-harness"
    : ".";
...
const upgradeSurvivorCommand =
  "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:upgrade-survivor";
const rootManagedVpsUpgradeCommand =
  "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:root-managed-vps-upgrade";
const updateRestartAuthCommand =
  "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:update-restart-auth";
const CODEX_HARNESS_API_KEY_ENV = "MARKETINGCLAW_LIVE_CODEX_HARNESS_AUTH=api-key";
...
function liveDockerScriptCommand(script, envPrefix = "", options = {}) {
  ...
  const skipBuild = options.skipBuild === false ? "" : "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 ";
  return `${prefix}${skipBuild}bash -c 'harness="\${MARKETINGCLAW_DOCKER_E2E_TRUSTED_HARNESS_DIR:-${LIVE_DOCKER_DEFAULT_HARNESS_DIR}}"; MARKETINGCLAW_LIVE_DOCKER_REPO_ROOT="\${MARKETINGCLAW_DOCKER_E2E_REPO_ROOT:-$PWD}" bash "$harness/scripts/${script}"'`;
}
...
function createPackageUpdateMaintenanceLanes() {
  return [
    npmLane("doctor-switch", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:doctor-switch", {
      stateScenario: "empty",
      weight: 3,
    }),
    npmLane(
      "update-channel-switch",
      "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:update-channel-switch",
      {
    ...
    npmLane("skill-install", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:skill-install", {
    ...
    npmLane(
      ...
      "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:published-upgrade-survivor",
      {
        stateScenario: "upgrade-survivor",
...
const bundledPluginInstallUninstallLanes = Array.from(
  ...
  (_, index) =>
    lane(
      ...
      `MARKETINGCLAW_BUNDLED_PLUGIN_SWEEP_TOTAL=${BUNDLED_PLUGIN_INSTALL_UNINSTALL_SHARDS} MARKETINGCLAW_BUNDLED_PLUGIN_SWEEP_INDEX=${index} MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:bundled-plugin-install-uninstall`,
      {
        estimateSeconds: 120,
        resources: ["npm"],
        stateScenario: "empty",
...
function livePluginToolLane() {
  return liveLane(
    "live-plugin-tool",
    "MARKETINGCLAW_LIVE_PLUGIN_TOOL_TIMEOUT_SECONDS=300 MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:live-plugin-tool",
    {
...
function liveOpenAiChatToolsLane() {
  return liveLane(
    "openai-chat-tools",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:openai-chat-tools",
    {
...
function liveMcpCodeModeGatewayLane() {
  return liveLane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:live-mcp-code-mode-gateway",
    {
...
function kitchenSinkRpcLane() {
  return serviceLane(
    "kitchen-sink-rpc",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:kitchen-sink-rpc",
    {
      resources: ["npm"],
      stateScenario: "empty",
      timeoutMs: 25 * 60 * 1000,
...
export const mainLanes = [
  serviceLane("compose-setup", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:compose-setup", {
    stateScenario: "empty",
    timeoutMs: 20 * 60 * 1000,
    weight: 3,
  }),
  npmLane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:package-install",
    {
      stateScenario: "empty",
      timeoutMs: 20 * 60 * 1000,
      weight: 3,
  ...
  liveLane(
    ...
    liveDockerScriptCommand(
      ...
      "MARKETINGCLAW_IMAGE=marketingclaw:local-live-gateway MARKETINGCLAW_DOCKER_BUILD_EXTENSIONS=matrix MARKETINGCLAW_LIVE_GATEWAY_PROVIDERS=claude-cli,google-gemini-cli",
      { skipBuild: false },
    ),
    {
      providers: ["claude-cli", "google-gemini-cli"],
  ...
  liveLane(
    ...
    liveDockerScriptCommand(
      "test-live-cli-backend-docker.sh",
      "MARKETINGCLAW_LIVE_CLI_BACKEND_ADVISORY=1 MARKETINGCLAW_LIVE_CLI_BACKEND_ALLOW_PROVIDER_SKIP=1 MARKETINGCLAW_LIVE_CLI_BACKEND_MODEL=google-gemini-cli/gemini-3-flash-preview",
    ),
    {
  ...
  liveLane("openwebui", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:openwebui", {
    e2eImageKind: "functional",
    needsLiveImage: false,
    provider: "openai",
    resources: ["service"],
  ...
  serviceLane("onboard", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:onboard", {
    stateScenario: "empty",
    weight: 2,
  }),
  npmLane("codex-on-demand", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:codex-on-demand", {
    resources: ["service"],
    stateScenario: "empty",
    weight: 3,
  }),
  serviceLane(
    "codex-media-path",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:codex-media-path",
    {
      resources: ["npm"],
      stateScenario: "empty",
      weight: 3,
  ...
  npmLane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:npm-onboard-channel-agent",
    { resources: ["service"], stateScenario: "empty", weight: 3 },
  ),
  npmLane(
    "npm-onboard-discord-channel-agent",
    "MARKETINGCLAW_NPM_ONBOARD_CHANNEL=discord MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:npm-onboard-channel-agent",
    { resources: ["service"], stateScenario: "empty", weight: 3 },
  ),
  npmLane(
    "npm-onboard-slack-channel-agent",
    "MARKETINGCLAW_NPM_ONBOARD_CHANNEL=slack MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:npm-onboard-channel-agent",
    { resources: ["service"], stateScenario: "empty", weight: 3 },
  ),
  npmLane(
    "release-user-journey",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:release-user-journey",
    {
      resources: ["npm", "service"],
      stateScenario: "empty",
      timeoutMs: 20 * 60 * 1000,
  ...
  npmLane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:release-typed-onboarding",
    {
      resources: ["npm", "service"],
      stateScenario: "empty",
      timeoutMs: 20 * 60 * 1000,
  ...
  npmLane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:release-media-memory",
    {
      resources: ["npm", "service"],
      stateScenario: "empty",
      timeoutMs: 20 * 60 * 1000,
  ...
  npmLane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:release-upgrade-user-journey",
    {
      resources: ["npm", "service"],
      stateScenario: "empty",
      timeoutMs: 30 * 60 * 1000,
  ...
  npmLane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:release-plugin-marketplace",
    {
      resources: ["npm"],
      stateScenario: "empty",
      timeoutMs: 20 * 60 * 1000,
  ...
  serviceLane(
    "gateway-network",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:gateway-network",
  ),
  ...
  serviceLane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:agents-delete-shared-workspace",
    { stateScenario: "empty" },
  ),
  serviceLane("mcp-channels", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:mcp-channels", {
    resources: ["npm"],
    stateScenario: "empty",
    weight: 3,
  }),
  serviceLane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:mcp-code-mode-gateway",
    {
      resources: ["npm"],
      stateScenario: "empty",
      weight: 3,
  ...
  lane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:agent-bundle-mcp-tools",
    {
      stateScenario: "empty",
    },
  ),
  lane(
    "crestodian-rescue",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:crestodian-rescue",
    {
      stateScenario: "empty",
    },
  ),
  lane(
    "crestodian-planner",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:crestodian-planner",
    {
      stateScenario: "empty",
    },
  ),
  serviceLane(
    "cron-mcp-cleanup",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:cron-mcp-cleanup",
    { resources: ["npm"], stateScenario: "empty", weight: 3 },
  ),
  ...createPackageUpdateMaintenanceLanes(),
  npmLane(
    "update-migration",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:update-migration",
    {
      stateScenario: "upgrade-survivor",
      timeoutMs: 30 * 60 * 1000,
      weight: 3,
  ...
  lane("plugins", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:plugins", {
    resources: ["npm", "service"],
    stateScenario: "empty",
    weight: 6,
  }),
  lane(
    "kitchen-sink-plugin",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:kitchen-sink-plugin",
    {
      resources: ["npm"],
      stateScenario: "empty",
      weight: 3,
  ...
  lane(
    "plugins-offline",
    "MARKETINGCLAW_PLUGINS_E2E_CLAWHUB=0 MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:plugins",
    {
      resources: ["npm", "service"],
      stateScenario: "empty",
      weight: 6,
  ...
  npmLane("plugin-update", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:plugin-update", {
    stateScenario: "empty",
  }),
  npmLane(
    "update-corrupt-plugin",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:update-corrupt-plugin",
    {
      stateScenario: "empty",
      timeoutMs: 30 * 60 * 1000,
      weight: 3,
  ...
  npmLane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:plugin-lifecycle-matrix",
    {
      stateScenario: "empty",
      timeoutMs: 12 * 60 * 1000,
    },
  ),
  serviceLane("config-reload", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:config-reload", {
    stateScenario: "empty",
  }),
  npmLane(
    "multi-node-update",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:multi-node-update",
    {
      stateScenario: "empty",
  ...
  lane(
    "openai-image-auth",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:openai-image-auth",
    {
      stateScenario: "empty",
    },
  ),
  lane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:crestodian-first-run",
    { stateScenario: "empty" },
  ),
  lane(
    "session-runtime-context",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:session-runtime-context",
  ),
  lane(
    "plugin-binding-command-escape",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=0 pnpm test:docker:plugin-binding-command-escape",
    {
      e2eImageKind: false,
      resources: ["npm"],
      stateScenario: "empty",
  ...
  lane(
    "commitments-safety",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:commitments-safety",
    {
      stateScenario: "empty",
    },
  ),
  liveLane(
    "npm-telegram-live",
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:npm-telegram-live",
    {
      e2eImageKind: "bare",
      provider: "openai",
...
export const tailLanes = [
  serviceLane(
    ...
    "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:openai-web-search-minimal",
  ...
  liveLane(
    ...
    liveDockerScriptCommand(
      ...
      "MARKETINGCLAW_LIVE_CODEX_HARNESS_AUTH=api-key MARKETINGCLAW_LIVE_CODEX_HARNESS_CHAT_IMAGE_PROBE=1 MARKETINGCLAW_LIVE_CODEX_HARNESS_IMAGE_PROBE=0 MARKETINGCLAW_LIVE_CODEX_HARNESS_MCP_PROBE=0 MARKETINGCLAW_LIVE_CODEX_HARNESS_SUBAGENT_PROBE=0 MARKETINGCLAW_LIVE_CODEX_HARNESS_GUARDIAN_PROBE=0",
    ),
    {
      cacheKey: "codex-harness",
      provider: "openai",
  ...
  liveLane(
    ...
    liveDockerScriptCommand(
      "test-live-codex-harness-docker.sh",
      `${CODEX_HARNESS_API_KEY_ENV} MARKETINGCLAW_LIVE_CODEX_BIND=1 MARKETINGCLAW_LIVE_CODEX_TEST_FILES=src/gateway/gateway-codex-bind.live.test.ts`,
    ),
    {
      cacheKey: "codex-harness",
      provider: "openai",
  ...
  liveLane(
    ...
    liveDockerScriptCommand(
      "test-live-acp-bind-docker.sh",
      "MARKETINGCLAW_LIVE_ACP_BIND_AGENT=droid MARKETINGCLAW_LIVE_ACP_BIND_REQUIRE_TRANSCRIPT=1",
    ),
    {
  ...
  liveLane(
    ...
    liveDockerScriptCommand(
      "test-live-acp-bind-docker.sh",
      "MARKETINGCLAW_LIVE_ACP_BIND_AGENT=opencode MARKETINGCLAW_LIVE_ACP_BIND_REQUIRE_TRANSCRIPT=1",
    ),
    {
...
const primaryReleasePathChunks = {
  core: [
    lane("qr", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:qr"),
    serviceLane("onboard", "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:onboard", {
      stateScenario: "empty",
      weight: 2,
    }),
    ...
    serviceLane(
      "config-reload",
      "MARKETINGCLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:config-reload",
      {
        stateScenario: "empty",
      },
    ),
...
export function releasePathChunkLanes(chunk, options = {}) {
  ...
  if (!base) {
    throw new Error(
      `MARKETINGCLAW_DOCKER_ALL_CHUNK must be one of: ${[
