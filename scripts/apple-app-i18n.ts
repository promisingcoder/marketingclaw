...
const CATALOGS = [
  {
    ...
    coverage: {
      ...
      "apps/shared/MarketingClawKit/Sources/MarketingClawChatUI/ChatMessageViews.swift": [
        "Writing",
      ],
    },
  },
  {
    path: "apps/macos/Sources/MarketingClaw/Resources/Localizable.xcstrings",
    coverage: {
      "apps/macos/Sources/MarketingClaw/ChannelsSettings+ChannelSections.swift": [
        "Logout",
        "Refresh",
        "Save",
      ],
      "apps/macos/Sources/MarketingClaw/CronSettings+Rows.swift": ["Run now"],
    },
  },
] as const;
