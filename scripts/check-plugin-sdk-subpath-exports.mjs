...
async function main() {
  ...
  if (violations.length === 0) {
    console.log("OK: all referenced marketingclaw/plugin-sdk/<subpath> imports are exported.");
    return;
  }

  console.error(
    "Rule: every referenced marketingclaw/plugin-sdk/<subpath> must exist in the public package exports.",
  );
