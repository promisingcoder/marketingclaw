...
const LIVEISH_INPUTS = Object.freeze([
  ...
  },
  {
    ...
    env: ["TELEGRAM_BOT_TOKEN", "MARKETINGCLAW_TELEGRAM_BOT_TOKEN"],
  },
  {
    probe: "channel-discord",
    env: ["DISCORD_TOKEN", "MARKETINGCLAW_DISCORD_TOKEN"],
  },
  {
    probe: "channel-slack",
    env: ["SLACK_BOT_TOKEN", "MARKETINGCLAW_SLACK_BOT_TOKEN"],
  },
  {
    probe: "channel-whatsapp",
    env: ["WHATSAPP_ACCESS_TOKEN", "MARKETINGCLAW_WHATSAPP_ACCESS_TOKEN"],
  },
]);
