...
profile_path="${1:-$HOME/.marketingclaw-testbox-live.profile}"
helper_path="${2:-$HOME/.local/bin/marketingclaw-testbox-env}"
...
profile_path="\${MARKETINGCLAW_TESTBOX_PROFILE_FILE:-\$default_profile_path}"
