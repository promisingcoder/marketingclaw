...
const DEFAULT_CLAWHUB_SOURCE_REPO = "marketingclaw/clawhub";
const CLAWHUB_DOCS_TARGET_DIR = "clawhub";
const CLAWHUB_REPO_ENV = "MARKETINGCLAW_DOCS_SYNC_CLAWHUB_REPO";
...
const SYNC_SUPPORT_FILES = [
  {
    ...
    target: path.join(".marketingclaw-sync", "check-docs-mdx.mjs"),
  },
  {
    source: path.join(ROOT, "scripts", "lib", "mintlify-accordion.mjs"),
    target: path.join(".marketingclaw-sync", "lib", "mintlify-accordion.mjs"),
  },
  {
    source: path.join(ROOT, ".github", "codex", "prompts", "docs-mdx-repair.md"),
    target: path.join(".marketingclaw-sync", "docs-mdx-repair.md"),
  },
];
...
export function parseArgs(argv) {
  const args = {
    ...
    clawhubSourceRepo:
      process.env.MARKETINGCLAW_DOCS_SYNC_CLAWHUB_SOURCE_REPO || DEFAULT_CLAWHUB_SOURCE_REPO,
    clawhubSourceSha: process.env.MARKETINGCLAW_DOCS_SYNC_CLAWHUB_SOURCE_SHA || "",
  };
...
function writeSyncMetadata(targetRoot, args, sources) {
  ...
  writeJson(path.join(targetRoot, ".marketingclaw-sync", "source.json"), metadata);
}
